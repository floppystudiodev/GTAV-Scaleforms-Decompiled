class com.rockstargames.gtav.minigames.horseracingwall.RaceProgress
{
   var view;
   var cards;
   var cardPositions;
   var currLeader;
   function RaceProgress(view, horses, app)
   {
      this.view = view;
      this.init(horses,app);
   }
   function init(horses, app)
   {
      this.cards = [];
      this.cardPositions = [];
      var _loc4_ = 0;
      while(_loc4_ < horses.length)
      {
         ...
         if(app.displayConfig.isAsian)
         {
            app.resizeAsianText(_loc2_.num);
         }
         ...
         com.rockstargames.gtav.minigames.horseracingwall.HORSE_RACING_WALL.colourise(_loc2_.horse.body,_loc3_.primaryColour);
         com.rockstargames.gtav.minigames.horseracingwall.HORSE_RACING_WALL.colourise(_loc2_.horse.arms,_loc3_.secondaryColour);
         com.rockstargames.gtav.minigames.horseracingwall.HORSE_RACING_WALL.colourise(_loc2_.horse.horse,_loc3_.horseColour);
         com.rockstargames.gtav.minigames.horseracingwall.HORSE_RACING_WALL.colourise(_loc2_.horse.mane,_loc3_.maneColour);
         _loc4_ = _loc4_ + 1;
      }
   ...
   function update(normProgress, horses)
   {
      ...
      {
         com.rockstargames.gtav.minigames.horseracingwall.HORSE_RACING_WALL.setSpacedText(this.view.leader.label,"#1 " + _loc4_[0].name,1.5,true,true);
         ...
         this.view.leader._x = 0.5 * (this.view._width - this.view.leader._width);
