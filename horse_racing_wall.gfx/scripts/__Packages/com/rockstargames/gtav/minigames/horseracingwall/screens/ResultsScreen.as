class com.rockstargames.gtav.minigames.horseracingwall.screens.ResultsScreen extends com.rockstargames.gtav.minigames.horseracingwall.Screen
{
   ...
   function initCards()
   {
      ...
      while(_loc4_ < 3)
      {
         ...
         var _loc2_ = this.view["horseCard" + (_loc4_ + 1)];
   ...
   function initPlayerLists()
   {
      ...
      {
         var _loc2_ = this.app.players[_loc3_];
         if(_loc2_.result != undefined)
         {
            if(_loc2_.result >= 0)
            {
               var _loc4_ = this.view.attachMovie("playerListItem","won" + this.winners.length,this.view.getNextHighestDepth());
   ...
   function updatePlayerLists()
   {
      ...
      while(_loc2_ < com.rockstargames.gtav.minigames.horseracingwall.screens.ResultsScreen.MAX_PLAYERS_IN_LIST)
      {
         ...
         {
            var _loc5_ = this.winners.length <= com.rockstargames.gtav.minigames.horseracingwall.screens.ResultsScreen.MAX_PLAYERS_IN_LIST ? 0 : this.playerDisplayOffset;
            var _loc3_ = this.view["won" + _loc2_];
            var _loc4_ = this.winners[(_loc2_ + _loc5_) % this.winners.length];
