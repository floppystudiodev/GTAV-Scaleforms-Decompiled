class com.rockstargames.gtav.levelDesign.arcadeBusinessHub.ImageManager
{
   var gfxName;
   var imageQueue;
   var txdRefs;
   ...
   function addImage(txd, id, imageMovieClip)
   {
      ...
      if(com.rockstargames.gtav.levelDesign.arcadeBusinessHub.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == com.rockstargames.gtav.levelDesign.arcadeBusinessHub.ImageManager.TXD_LOADED)
      {
         this.displayImage(txd,id,imageMovieClip);
      }
      else
      {
         if(this.txdRefs[txd] != com.rockstargames.gtav.levelDesign.arcadeBusinessHub.ImageManager.TXD_LOADING)
         {
            this.txdRefs[txd] = com.rockstargames.gtav.levelDesign.arcadeBusinessHub.ImageManager.TXD_LOADING;
   ...
   {
      this.txdRefs[txd] = com.rockstargames.gtav.levelDesign.arcadeBusinessHub.ImageManager.TXD_LOADED;
