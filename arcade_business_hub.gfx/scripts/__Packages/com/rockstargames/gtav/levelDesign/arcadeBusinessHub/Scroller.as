class com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller
{
   ...
   function Scroller(content, mask, handle, track, momentumListener, restoreIndex)
   {
      ...
      if(restoreIndex >= 0 && restoreIndex < com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.STORED_CONTENT_POSITIONS.length)
      {
         content._y = com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.STORED_CONTENT_POSITIONS[restoreIndex];
         handle._y = com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.STORED_HANDLE_POSITIONS[restoreIndex];
         if(momentumListener)
         {
            momentumListener();
         }
   ...
   function update()
   {
      if(this.content._height > this.mask._height)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.to(this.handle,0.5 * com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.HANDLE_FADE_DURATION,{_alpha:0});
      }
      else
      {
   ...
   function dispose()
   {
      ...
      {
         com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.STORED_CONTENT_POSITIONS[this.restoreIndex] = this.content._y;
         com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.STORED_HANDLE_POSITIONS[this.restoreIndex] = this.handle._y;
      }
   ...
   function scrollBy(dy, isMouseWheel)
   {
      if(isMouseWheel)
      {
         ...
         dy *= com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.MOUSEWHEEL_SPEED_MULTIPLIER;
      }
      dy = (128 - dy) / 128;
      this.applyScroll(dy);
      if(isMouseWheel && this.momentumListener != undefined)
      {
         this.momentumArgs.onCompleteArgs[0] = dy;
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.content,com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.FRAME_DURATION,this.momentumArgs);
      }
      this.handle._alpha = 100;
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.handle,com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.HANDLE_FADE_DURATION,{_alpha:0});
   }
   function applyScroll(dy)
   {
      var _loc2_ = this.content._y + com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.SCROLL_SPEED * dy;
   ...
   {
      dy *= com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.MOUSEWHEEL_MOMENTUM_DAMPING;
      this.applyScroll(dy);
      this.momentumListener();
      if(Math.abs(dy) > com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.MIN_MOUSEWHEEL_MOMENTUM)
      {
         this.momentumArgs.onCompleteArgs[0] = dy;
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.content,com.rockstargames.gtav.levelDesign.arcadeBusinessHub.Scroller.FRAME_DURATION,this.momentumArgs);
      }
