class com.rockstargames.gtav.levelDesign.celebration.HEIST_CELEBRATION extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function ADD_BACKGROUND_TO_WALL(id, alpha, moneyMesh)
   {
      var _loc2_ = moneyMesh > 0;
      this.sequences[id].addBackground(alpha,_loc2_);
   }
   function ADD_MISSION_RESULT_TO_WALL(id, missionTextLabel, passFailTextLabel, messageLabel, isMessageRawText, isPassFailRawText, isMissionTextRawText)
   {
      ...
      var _loc6_ = new com.rockstargames.gtav.levelDesign.celebration.steps.MissionResultStep(this.sequences[id],_loc4_,_loc5_,_loc3_);
   ...
   function ADD_COMPLETE_MESSAGE_TO_WALL(id, missionTextLabel, completeTextLabel, messageLabel, isMessageRawText, isCompleteRawText, isMissionTextRawText)
   {
      ...
      var _loc4_ = new com.rockstargames.gtav.levelDesign.celebration.steps.CompleteStep(this.sequences[id],_loc3_,_loc2_);
      this.sequences[id].addStep(_loc4_);
   }
   function CREATE_STAT_TABLE(id, stepId)
   {
      var _loc2_ = new com.rockstargames.gtav.levelDesign.celebration.steps.StatTableStep(this.sequences[id],stepId);
   ...
   function ADD_STAT_TO_TABLE(id, stepId, name, value, isNameRawText, isValueRawText, isTotalRow, isStatValueTime, colourId)
   {
      ...
      var _loc5_ = com.rockstargames.gtav.levelDesign.celebration.steps.StatTableStep(this.sequences[id].getStepById(stepId));
      var _loc4_ = this.getColourFromId(colourId);
      _loc5_.addStat(name,value,_loc4_);
   }
   function ADD_STAT_TABLE_TO_WALL(id, stepId)
   {
      var _loc2_ = com.rockstargames.gtav.levelDesign.celebration.steps.StatTableStep(this.sequences[id].getStepById(stepId));
   ...
   {
      var _loc2_ = new com.rockstargames.gtav.levelDesign.celebration.steps.BigDollarsStep(this.sequences[id],stepId);
      this.sequences[id].addStep(_loc2_);
   }
   ...
   {
      var _loc8_ = com.rockstargames.gtav.levelDesign.celebration.steps.BigDollarsStep(this.sequences[id].getStepById(stepId));
   ...
   function ADD_JOB_POINTS_TO_WALL(id, points, xAlign)
   {
      ...
      var _loc3_ = new com.rockstargames.gtav.levelDesign.celebration.steps.JPStep(this.sequences[id],points,_loc2_);
   ...
   {
      var _loc2_ = new com.rockstargames.gtav.levelDesign.celebration.steps.RPAndRankBarStep(this.sequences[id],repPointsGained,startRepPoints,minRepPointsForRank,maxRepPointsForRank,currentRank,nextRank,rank1Txt,rank2Txt);
      this.sequences[id].addStep(_loc2_);
   }
   ...
   {
      var _loc2_ = new com.rockstargames.gtav.levelDesign.celebration.steps.SmallDollarsStep(this.sequences[id],title,description,value);
      this.sequences[id].addStep(_loc2_);
   }
   function ADD_CASH_WON_TO_WALL(id, statLabel, finalValue, startValue, xAlign, isRawText)
   {
      ...
      var _loc4_ = new com.rockstargames.gtav.levelDesign.celebration.steps.CashStep(this.sequences[id],startValue,finalValue,_loc3_);
      this.sequences[id].addStep(_loc4_);
   }
   function ADD_CASH_TO_WALL(id, value, xAlign)
   {
      ...
      var _loc3_ = xAlign == "left";
      var _loc4_ = new com.rockstargames.gtav.levelDesign.celebration.steps.CashStep(this.sequences[id],value,value,_loc3_);
      this.sequences[id].addStep(_loc4_);
   }
   function CLEANUP(id)
   {
   ...
   function createSequence(bgColour, sfxId, id)
   {
      ...
      {
         case "BG":
            _loc2_ = new com.rockstargames.gtav.levelDesign.celebration.CelebrationSequenceBG(this.CONTENT,bgColour,this.dispConf,sfxId,id,4);
            break;
         case "FG":
            _loc2_ = new com.rockstargames.gtav.levelDesign.celebration.CelebrationSequenceFG(this.CONTENT,bgColour,this.dispConf,sfxId,id,2);
            break;
         case "CUTOUT":
            _loc2_ = new com.rockstargames.gtav.levelDesign.celebration.CelebrationSequenceCutout(this.CONTENT,bgColour,this.dispConf,sfxId,id,1);
            break;
         default:
            _loc2_ = new com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence(this.CONTENT,bgColour,this.dispConf,sfxId,id,0);
      }
      return _loc2_;
   }
