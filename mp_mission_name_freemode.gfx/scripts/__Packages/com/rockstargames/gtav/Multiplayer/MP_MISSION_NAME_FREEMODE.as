class com.rockstargames.gtav.Multiplayer.MP_MISSION_NAME_FREEMODE extends com.rockstargames.gtav.levelDesign.BaseScriptUI
{
   ...
   {
      this.CONTENT.missionNameTF.text = "";
      this.CONTENT.missionTypeTF.htmlText = "";
      this.CONTENT.infoPanel.percentageTF.htmlText = "";
      this.CONTENT.infoPanel.playersRequiredTF.htmlText = "";
      this.CONTENT.infoPanel.timeTF.htmlText = "";
      var _loc3_ = false;
      if(RP == undefined)
      {
         RP = 0;
      ...
      if(missionName != undefined && missionName != "")
      {
         ...
         {
            this.CONTENT.missionNameTF.text += " " + this.TIMELINE.verified.text;
   ...
   function debug()
   {
      this.SET_MISSION_INFO("Stunt - Trench I","<FONT COLOR=\'#FC73C9\'>Stunt Series","","","LB - 0",false,"",0,0,"");
      this.SET_MISSION_INFO("","<FONT COLOR=\'#F0F0F0\'>Arm Wrestling","","","",false,"2",0,0,"");
   }
}
