class com.rockstargames.gtav.levelDesign.nightclub.ImageManager
{
   var gfxName;
   var txdRefs;
   var imageQueue;
   ...
   function addImage(txd, id, imageMovieClip)
   {
      ...
      if(com.rockstargames.gtav.levelDesign.nightclub.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == com.rockstargames.gtav.levelDesign.nightclub.ImageManager.TXD_LOADED)
      {
         this.displayImage(txd,id,imageMovieClip);
      }
      else
      {
         if(this.txdRefs[txd] != com.rockstargames.gtav.levelDesign.nightclub.ImageManager.TXD_LOADING)
         {
            this.txdRefs[txd] = com.rockstargames.gtav.levelDesign.nightclub.ImageManager.TXD_LOADING;
   ...
   {
      this.txdRefs[txd] = com.rockstargames.gtav.levelDesign.nightclub.ImageManager.TXD_LOADED;
