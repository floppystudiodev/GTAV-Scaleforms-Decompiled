class com.rockstargames.gtav.cellphone.apps.MESSAGE_VIEW extends com.rockstargames.gtav.cellphone.apps.APP_ScrollingView
{
   ...
   function populateContent()
   {
      ...
      switch(Number(this.messageStyle))
      {
         ...
         case com.rockstargames.gtav.cellphone.MessageType.MESSAGE_TYPE_ADVERSARY:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_ADVERSARY);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.LOW_FLOW:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_LOW_FLOW);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G1:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G1);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G2:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G2);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G3:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G3);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G4:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G4);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G5:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G5);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G6:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G6);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G7:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G7);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G8:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G8);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G9:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G9);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G10:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G10);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G11:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G11);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G12:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G12);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G13:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G13);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G14:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G14);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_G15:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_G15);
            this.content.background._alpha = 75;
            break;
         case com.rockstargames.gtav.cellphone.MessageType.STYLE_TECH_GREEN:
            com.rockstargames.ui.utils.Colour.ApplyHudColour(this.content.background,com.rockstargames.ui.utils.HudColour.HUD_COLOUR_TECH_GREEN);
            this.content.background._alpha = 75;
            break;
         default:
   ...
   {
      var _loc2_ = this.content.messageBody;
      _loc2_.autoSize = "left";
      _loc2_.html = true;
      _loc2_.htmlText = this.messageBody;
      if(this.messageStyle == com.rockstargames.gtav.cellphone.MessageType.MESSAGE_TYPE_ADVERSARY)
      {
         _loc2_.textColor = 16777215;
         this.content.fromAddress.textColor = 16777215;
      }
      ...
      var _loc3_ = this.content._height;
      var _loc5_ = _loc3_ - this.gutterHeight;
      var _loc4_ = _loc5_ / _loc3_;
      this.scrollBar.scrollBarContainer.scrubber._height = Math.round((1 - _loc4_) * this.gutterHeight);
   }
