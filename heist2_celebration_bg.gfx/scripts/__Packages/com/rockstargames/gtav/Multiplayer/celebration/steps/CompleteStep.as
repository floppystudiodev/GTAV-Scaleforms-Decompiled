class com.rockstargames.gtav.Multiplayer.celebration.steps.CompleteStep extends com.rockstargames.gtav.Multiplayer.celebration.steps.Step
{
   var missionTitle;
   var complete;
   var initialised;
   ...
   {
      super(sequence,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_HEIGHT,"CompleteStep");
   ...
   function init(container, y)
   {
      ...
      var _loc14_ = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_WIDTH - 2 * _loc4_.completeText._x;
      var _loc10_ = _loc14_ / _loc4_.completeText.textWidth;
      if(!com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.IS_ASIAN || _loc10_ < 1)
      {
         _loc4_.completeText._xscale = _loc4_.completeText._yscale = 100 * _loc10_;
      }
      _loc4_.completeText._y = 0.5 * com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_HEIGHT - 0.46 * _loc4_.completeText._height;
      ...
      var _loc9_ = com.rockstargames.gtav.Multiplayer.celebration.steps.Step.PRICEDOWN_ASCENDER * _loc4_.completeText._height;
      ...
      var _loc11_ = com.rockstargames.gtav.Multiplayer.celebration.steps.CompleteStep.SLIDE_IN_MULTIPLIER * com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION;
      var _loc12_ = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_HEIGHT - com.rockstargames.gtav.Multiplayer.celebration.CelebrationBackground.SLOPE_Y_DELTA;
   ...
   function start()
   {
      ...
      this.sequence.pushDownBackground(_loc2_,com.rockstargames.gtav.Multiplayer.celebration.steps.CompleteStep.SLIDE_IN_MULTIPLIER * com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION);
   }
   function finish()
   {
      super.finish();
   ...
   {
      this.sequence.setGlobalFlag(com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.COMPLETE_MESSAGE_SHOWN);
   }
   function startPause()
   {
