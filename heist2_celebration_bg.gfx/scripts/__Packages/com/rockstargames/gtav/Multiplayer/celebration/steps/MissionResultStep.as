class com.rockstargames.gtav.Multiplayer.celebration.steps.MissionResultStep extends com.rockstargames.gtav.Multiplayer.celebration.steps.Step
{
   ...
   function init(container, y)
   {
      ...
      var _loc18_ = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_WIDTH - 2 * _loc3_.passFailText._x;
      var _loc15_ = _loc18_ / _loc3_.passFailText.textWidth;
      if(!com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.IS_ASIAN || _loc15_ < 1)
      {
         _loc3_.passFailText._xscale = _loc3_.passFailText._yscale = 100 * _loc15_;
      }
      _loc3_.passFailText._y = 0.5 * com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_HEIGHT - 0.46 * _loc3_.passFailText._height;
      ...
      {
         if(_loc3_.missionTitleText._x + _loc3_.missionTitleText.textWidth > com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_WIDTH)
         {
            _loc3_.missionTitleText.autoSize = "none";
            _loc3_.missionTitleText.textAutoSize = "shrink";
            _loc3_.missionTitleText._width = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_WIDTH * this.sequence.displayConfig.safeRight - _loc3_.missionTitleText._x;
         }
      }
      var _loc13_ = com.rockstargames.gtav.Multiplayer.celebration.steps.Step.PRICEDOWN_ASCENDER * _loc3_.passFailText._height;
      ...
      if(this.message != "")
      {
         ...
         while(_loc6_ < this.passFail.length)
         {
            ...
            while(_loc4_ < _loc5_.length)
            {
               ...
               {
                  _loc11_ = com.rockstargames.gtav.Multiplayer.celebration.steps.Step.PRICEDOWN_DESCENDER * _loc3_.passFailText._height;
                  _loc9_ = true;
                  break;
               }
               _loc4_ = _loc4_ + 1;
         ...
         _loc3_.messageText._y = _loc3_.passFailText._y + (com.rockstargames.gtav.Multiplayer.celebration.steps.Step.PRICEDOWN_ASCENDER + com.rockstargames.gtav.Multiplayer.celebration.steps.Step.PRICEDOWN_BODY) * _loc3_.passFailText._height + _loc11_;
      }
      _loc3_.passFailText.text = this.passFail;
      ...
      _loc3_._y += _loc16_;
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.content,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION,{_y:this.baseY,ease:com.rockstargames.ui.tweenStar.Ease.QUARTIC_IN,onComplete:this.startPause,onCompleteScope:this});
   }
   function start()
   {
      if(this.started)
      ...
      var _loc2_ = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_HEIGHT + Math.abs(com.rockstargames.gtav.Multiplayer.celebration.CelebrationBackground.SLOPE_Y_DELTA);
      ...
      this.sequence.pushDownBackground(_loc2_,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION);
      this.sequence.setGlobalFlag(com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.BACKGROUND_START_TWEEN_IN);
   }
   function finish()
   {
      super.finish();
   ...
   function startPause()
   {
      this.sequence.setGlobalFlag(com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.BACKGROUND_FINISH_TWEEN_IN);
