class com.rockstargames.gtav.levelDesign.iaaHeistBoard.ImageManager
{
   var imageQueue;
   var txdRefs;
   ...
   function addImage(txd, id, imageMovieClip)
   {
      ...
      if(com.rockstargames.gtav.levelDesign.iaaHeistBoard.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == "loaded")
      {
      ...
      else
      {
         ...
         {
            com.rockstargames.ui.game.GameInterface.call("REQUEST_TXD_AND_ADD_REF",com.rockstargames.ui.game.GameInterface.GENERIC_TYPE,"IAA_HEIST_BOARD",txd,id,true);
