class com.rockstargames.gtav.levelDesign.heists.selectors.MPHeistBoardTodoItem extends com.rockstargames.ui.components.GUIMenuItem
{
   ...
   function set data(_d)
   {
      ...
      if(this._data[0] != undefined)
      {
         ...
         while(_loc5_ < this._data.length)
         {
            ...
            {
               _loc3_ = this.container.attachMovie("todoLineMC",_loc28_,this.container.getNextHighestDepth(),{_x:0,_y:_loc21_});
               _loc3_.bgMC._visible = false;
               _loc3_.postItNote._visible = false;
               _loc4_ = _loc3_.todoItemTF;
               ...
               _loc4_.html = true;
               _loc12_ = _loc4_.getNewTextFormat();
               _loc12_.size = _loc32_;
               _loc4_.setTextFormat(_loc12_);
               _loc16_ = this.getHUDColourHex(com.rockstargames.ui.utils.HudColour.HUD_COLOUR_WHITE).toUpperCase();
               _loc23_ = _loc16_.toLowerCase();
               _loc9_ = this.getHUDColourHex(com.rockstargames.gtav.levelDesign.heists.HeistColours.BLUE);
               _loc2_ = this._data[_loc7_].split(_loc16_).join(_loc9_).split(_loc23_).join(_loc9_);
               if(_loc2_ != undefined && _loc2_ != "")
               {
                  _loc2_ = "<FONT COLOR=\'" + _loc9_ + "\'>" + _loc2_;
                  _loc15_ = this.getHUDColourHex(com.rockstargames.ui.utils.HudColour.HUD_COLOUR_YELLOW).toUpperCase();
                  _loc22_ = _loc15_.toLowerCase();
                  _loc18_ = this.getHUDColourHex(com.rockstargames.ui.utils.HudColour.HUD_COLOUR_BLUE).toUpperCase();
                  _loc26_ = _loc18_.toLowerCase();
                  _loc19_ = this.getHUDColourHex(com.rockstargames.ui.utils.HudColour.HUD_COLOUR_GREEN).toUpperCase();
                  _loc25_ = _loc19_.toLowerCase();
                  _loc14_ = this.getHUDColourHex(com.rockstargames.ui.utils.HudColour.HUD_COLOUR_HB_YELLOW);
                  _loc17_ = this.getHUDColourHex(com.rockstargames.ui.utils.HudColour.HUD_COLOUR_HB_BLUE);
                  _loc13_ = this.getHUDColourHex(com.rockstargames.ui.utils.HudColour.HUD_COLOUR_RADAR_HEALTH);
                  ...
                  _loc24_ = _loc2_.indexOf("[");
                  _loc27_ = _loc2_.indexOf("]");
                  _loc10_ = _loc24_ != -1 ? true : false;
                  _loc20_ = _loc27_ != -1 ? true : false;
                  _loc11_ = _loc10_;
   ...
   function renumberPostIts()
   {
      ...
      while(_loc2_ < 21)
      {
         ...
         _loc3_ = this.container[_loc4_];
         if(this.container[_loc4_] != undefined)
         {
            _loc5_ = this.showPostItNoteList[_loc2_];
            if(_loc5_)
            {
