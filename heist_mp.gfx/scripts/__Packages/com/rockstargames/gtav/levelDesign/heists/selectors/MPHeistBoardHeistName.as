class com.rockstargames.gtav.levelDesign.heists.selectors.MPHeistBoardHeistName extends com.rockstargames.ui.components.GUIMenuItem
{
   ...
   function set data(_d)
   {
      ...
      if(_loc18_ == true)
      {
         ...
         _loc15_ = this.emailTopRight + "<br>" + _loc10_ + "<br>" + _loc6_;
         ...
         _loc12_ = this.heistDescription.heistDescEmailHeaderTF._width + this.heistDescription.heistDescEmailInfoTF._width;
         if(_loc12_ > 160)
         {
            _loc7_ = 160 / _loc12_ * 100;
         ...
         _loc14_ = 30 + Math.max(this.heistDescription.heistDescEmailHeaderTF._height,this.heistDescription.heistDescEmailInfoTF._height);
         ...
         if(_loc9_ != "" && _loc9_ != undefined && _loc9_ != null)
         {
            ...
            _loc2_ = this.heistDescription.heistDescTF;
            _loc2_.htmlText = _loc11_;
            _loc2_.autoSize = "left";
            _loc2_.wordWrap = true;
            _loc2_.multiline = true;
            _loc2_.html = true;
            _loc3_ = _loc2_.getNewTextFormat();
            _loc3_.size = 8;
   ...
   function setPlayerName(_playerName)
   {
      ...
      {
         _loc2_ = _playerName + "@eyefind.info";
