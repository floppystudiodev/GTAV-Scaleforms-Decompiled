class com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor
{
   var view;
   var bounds;
   var targets;
   ...
   function joystick(dx, dy)
   {
      ...
      dy = (dy - 127) / 127;
      var _loc2_ = getTimer();
      var _loc6_ = this.clamp(_loc2_ - this.joystickTimestamp,0,com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.MAX_JOYSTICK_CALL_INTERVAL);
      var _loc3_ = com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.JOYSTICK_SPEED * _loc6_;
   ...
   function tweenTo(goalX, goalY)
   {
      ...
      var _loc4_ = _loc6_ / com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.ANIMATION_SPEED;
      var _loc5_ = getTimer();
   ...
   function updateTween(startX, startY, dx, dy, duration, startTime)
   {
      ...
      if(_loc3_ < 1)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.TWEEN_UPDATE_INTERVAL,this.tweenArgs);
      }
      else
      {
         this.stopTween();
   ...
   function findTargetInDirection(direction)
   {
      ...
      if(this.activeTarget != null)
      {
         switch(direction)
         {
            case com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.LEFT:
               _loc13_ = this.activeTarget.navLeft;
               break;
            case com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.RIGHT:
               _loc13_ = this.activeTarget.navRight;
               break;
            case com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.UP:
               _loc13_ = this.activeTarget.navUp;
               break;
            case com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.DOWN:
               _loc13_ = this.activeTarget.navDown;
         }
         if(_loc13_ === com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.NULL_TARGET_ID)
         {
            return null;
         }
         if(_loc13_ != undefined)
         {
            _loc15_ = this.getTargetByID(_loc13_);
            if(_loc15_ != null)
            {
               return _loc15_;
            }
      ...
      var _loc14_ = direction == com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.LEFT || direction == com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.RIGHT;
      ...
      while(_loc7_ < _loc10_)
      {
         ...
         if(!(!_loc2_.enabled || _loc2_ == this.activeTarget))
         {
            if(_loc14_)
            {
               _loc6_ = direction != com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.LEFT ? _loc2_.cx - this.x : this.x - _loc2_.cx;
               _loc3_ = _loc2_.t - this.y;
               _loc4_ = _loc2_.b - this.y;
            }
            else
            {
               _loc6_ = direction != com.rockstargames.gtav.levelDesign.salvagePlanning.navigation.Cursor.UP ? _loc2_.cy - this.y : this.y - _loc2_.cy;
