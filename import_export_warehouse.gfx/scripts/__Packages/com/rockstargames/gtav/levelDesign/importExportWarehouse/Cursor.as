class com.rockstargames.gtav.levelDesign.importExportWarehouse.Cursor
{
   ...
   function Cursor(view, debugView, displayConfig)
   {
      ...
      {
         this.xMin += com.rockstargames.gtav.levelDesign.importExportWarehouse.Cursor.LEFT_MARGIN;
      }
      if(displayConfig.safeRight == 1)
      {
         this.xMax -= com.rockstargames.gtav.levelDesign.importExportWarehouse.Cursor.RIGHT_MARGIN;
      }
      if(displayConfig.safeTop == 0)
      {
         this.yMin += com.rockstargames.gtav.levelDesign.importExportWarehouse.Cursor.TOP_MARGIN;
      }
      if(displayConfig.safeBottom == 1)
      {
         this.yMax -= com.rockstargames.gtav.levelDesign.importExportWarehouse.Cursor.BOTTOM_MARGIN;
      }
   ...
   function moveTo(x, y, instant, absolute)
   {
      if(!absolute)
      {
         x *= com.rockstargames.gtav.levelDesign.importExportWarehouse.Cursor.STAGE_WIDTH;
         y *= com.rockstargames.gtav.levelDesign.importExportWarehouse.Cursor.STAGE_HEIGHT;
      }
