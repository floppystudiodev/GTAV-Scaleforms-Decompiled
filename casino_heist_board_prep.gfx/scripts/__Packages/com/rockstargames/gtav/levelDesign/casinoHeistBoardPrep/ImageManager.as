class com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.ImageManager
{
   var gfxName;
   var imageQueue;
   var txdRefs;
   ...
   function addImage(txd, id, imageMovieClip)
   {
      ...
      if(com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.ImageManager.TXD_LOADED)
      {
         this.displayImage(txd,id,imageMovieClip);
      }
      else
      {
         if(this.txdRefs[txd] != com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.ImageManager.TXD_LOADING)
         {
            this.txdRefs[txd] = com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.ImageManager.TXD_LOADING;
   ...
   {
      this.txdRefs[txd] = com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.ImageManager.TXD_LOADED;
