class com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor
{
   var _x;
   var _y;
   var activeRect;
   ...
   static var STAGE_WIDTH = 960;
   static var STAGE_HEIGHT = 720;
   static var BASE_SPEED = 16;
   static var FRAME_DURATION = 33.333333333333336;
   static var MAX_FRAME_DURATION = 2 * com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.FRAME_DURATION;
   ...
   function Cursor(view, debugView, displayConfig)
   {
      ...
      this.xMin = 0;
      this.xMax = com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.STAGE_WIDTH;
      this.yMin = 0;
      this.yMax = com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.STAGE_HEIGHT;
      view._x = this._x = this.goalX = 0.5 * com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.STAGE_WIDTH;
      view._y = this._y = this.goalY = 0.5 * com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.STAGE_HEIGHT;
      this.moveByTimestamp = 0;
      this.setSpeed(com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.BASE_SPEED);
   }
   function get x()
   {
      return this._x;
   ...
   function moveTo(x, y, instant, absolute)
   {
      if(!absolute)
      {
         x *= com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.STAGE_WIDTH;
         y *= com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.STAGE_HEIGHT;
      }
   ...
   function moveBy(dx, dy)
   {
      ...
      dy = (dy - 128) / 128;
      var _loc2_ = getTimer();
      var _loc7_ = Math.min(com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.MAX_FRAME_DURATION,_loc2_ - this.moveByTimestamp);
      var _loc3_ = this.speed * _loc7_ / com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.FRAME_DURATION;
   ...
   {
      var _loc2_;
      if(this.state != com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.STATE_BUSY)
      {
         _loc2_ = this.getRectUnderPoint(this._x,this._y);
         this.setState(!_loc2_ ? com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.STATE_ARROW : com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.STATE_HAND);
      }
   }
   ...
   {
      var _loc11_ = direction == com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.LEFT || direction == com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.RIGHT;
      var _loc5_;
      var _loc8_;
      var _loc3_;
      var _loc6_;
      ...
      while(_loc2_)
      {
         ...
         else
         {
            if(_loc11_)
            {
               _loc5_ = direction != com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.LEFT ? _loc2_.cx - this._x : this._x - _loc2_.cx;
               _loc3_ = _loc2_.top - this._y;
               _loc6_ = _loc2_.bottom - this._y;
            }
            else
            {
               _loc5_ = direction != com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Cursor.UP ? _loc2_.cy - this._y : this._y - _loc2_.cy;
            ...
            if(_loc5_ > 0)
            {
               ...
               if(_loc4_ < _loc5_)
               {
                  ...
                  else if(_loc4_ == _loc7_ && _loc5_ < _loc8_)
                  {
                     _loc9_ = _loc2_;
                     _loc8_ = _loc5_;
                  }
      ...
      if(_loc9_)
      {
         this.moveTo(_loc9_.cx,_loc9_.cy,true,true);
         return true;
      }
      return false;
   }
   ...
   function insertRectAfter(rect, left, right, top, bottom)
   {
      ...
      _loc2_ = this.rectPool || new com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Rect();
   ...
   {
      var _loc2_ = this.rectPool || new com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.Rect();
      this.rectPool = _loc2_.next;
      _loc2_.left = left;
      _loc2_.right = right;
      _loc2_.top = top;
