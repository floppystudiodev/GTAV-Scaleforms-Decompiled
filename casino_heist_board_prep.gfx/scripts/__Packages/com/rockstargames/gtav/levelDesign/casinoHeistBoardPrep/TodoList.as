class com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.TodoList
{
   var view;
   var nextItemY;
   var items;
   ...
   {
      this.view = view;
      this.nextItemY = com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.TodoList.ROW_TOP_OFFSET;
      com.rockstargames.gtav.levelDesign.CASINO_HEIST_BOARD_PREP.setLocalisedText(view.title,titleLabel);
   ...
   function addItem(itemText, isComplete)
   {
      ...
      this.nextItemY += _loc2_._height + com.rockstargames.gtav.levelDesign.casinoHeistBoardPrep.TodoList.ROW_SPACING;
