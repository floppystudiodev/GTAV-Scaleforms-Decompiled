class com.rockstargames.gtav.pauseMenu.pauseMenuItems.PauseMenuContentBase extends com.rockstargames.gtav.levelDesign.BaseScriptUI
{
   ...
   function MENU_SECTION_MOVE(dir)
   {
      ...
      if(this.menuIndex < 0)
      {
         this.menuIndex += this.menuList.length;
      }
   ...
   function FOCUS_CONTENT(f)
   {
      ...
      if(this.isDimmable)
      {
         ...
         if(!f)
         {
            _loc6_ = new com.rockstargames.ui.utils.HudColour();
         ...
         _loc8_ = new flash.geom.Transform(this.CONTENT);
         _loc9_ = new flash.geom.ColorTransform(_loc5_,_loc5_,_loc5_,_loc7_,0,0,0,0);
         _loc8_.colorTransform = _loc9_;
         _loc3_ = this.currentPage.columnList.length;
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
   ...
   function MENU_SHIFT_DEPTH(dir, DontFallOff, SkipChecks)
   {
      ...
      if(this.menuInteractState(dir) == this.interact_idle || SkipChecks)
      {
         ...
         _loc14_ = this.MENU_KEY_PRESS_ACTIONS(dir);
         if(_loc14_)
         {
            _loc10_ = this.menuState;
            this.dbg("MENU_SHIFT_DEPTH | direction=(1/-1): " + dir);
            if(dir > 0 && !SkipChecks)
            {
               this.TRIGGER_PAUSE_MENU_EVENT();
            }
            _loc7_ = this.menuLevel + dir;
            _loc12_ = this.currentPage.getMaxColumns();
            if(_loc7_ < 0)
            {
               _loc7_ = 0;
            }
            ...
            _loc16_ = this.menuState != com.rockstargames.gtav.constants.PauseMenuLUT.MAP && (SkipChecks == undefined || SkipChecks == false);
            if(dir < 0)
            {
            ...
            else if(_loc16_)
            {
               ...
               _loc6_ = _loc9_.model.getCurrentView().itemList;
               if(_loc6_ == undefined)
               {
               ...
               while(_loc2_ < _loc5_)
               {
                  _loc3_ = com.rockstargames.gtav.pauseMenu.pauseMenuItems.PauseMenuBaseItem(_loc6_[_loc2_]);
            ...
            if(this.menuLevel == 0)
            {
               _loc15_ = this.menuList[this.menuIndex];
            ...
            if(_loc9_ != undefined)
            {
               _loc17_ = this.getSelectedMenuItem(_loc9_);
               _loc11_ = _loc17_.uniqueID;
            }
            if(_loc11_ != undefined)
            {
               this.menuUniqueID = _loc11_;
               if(dir < 0)
               {
                  com.rockstargames.ui.game.GameInterface.call("LAYOUT_CHANGED",com.rockstargames.ui.game.GameInterface.PAUSE_TYPE,_loc10_,this.menuState,this.menuUniqueID,dir);
                  this.dbg("---->LAYOUT_CHANGED oldMenuState: " + _loc10_ + " | menuState: " + this.menuState + " | menuUniqueID: " + this.menuUniqueID + " | dir: " + dir);
               }
               else
               {
                  com.rockstargames.ui.game.GameInterface.call("REFRESH_PROMPTS",com.rockstargames.ui.game.GameInterface.PAUSE_TYPE,_loc10_,this.menuState);
               }
            }
   ...
   function MENU_SET_FOCUS(isFocused, clearAll)
   {
      ...
      this.dbg("MENU_SET_FOCUS | columnID " + _loc2_.columnID + " columnMC: " + _loc2_ + " isFocused: " + isFocused);
   ...
   function MENU_INTERACTION(inputID, mPress, pressID, bIgnoreStateChange)
   {
      ...
      if(this.menuInteractState(inputID) == this.interact_idle || _loc4_)
      {
         ...
         _loc9_ = this.getSelectedMenuItem(_loc3_);
         _loc15_ = _loc9_.menuID;
         _loc14_ = _loc9_.uniqueID;
         _loc16_ = _loc9_.index;
         ...
         if(inputID == com.rockstargames.ui.game.GamePadConstants.DPADDOWN || inputID == com.rockstargames.ui.game.GamePadConstants.DPADUP || _loc4_)
         {
            ...
            _loc2_ = this.getSelectedMenuItem(_loc3_);
            ...
            if(_loc2_.menuID != undefined)
            {
               ...
               this.dbg("menuUniqueID " + this.menuUniqueID);
               this.dbg("---------------------- ");
               if(_loc2_.menuID != this.menuState || _loc2_.uniqueID != this.menuUniqueID)
               {
                  _loc11_ = 0;
                  this.dbg("In Context menu:" + this.inContext);
                  if(this.inContext)
                  {
                     com.rockstargames.ui.game.GameInterface.call("LAYOUT_CHANGED",com.rockstargames.ui.game.GameInterface.PAUSE_TYPE,this.menuState,_loc2_.menuID,_loc2_.uniqueID,_loc11_);
                  ...
                  _loc6_ = com.rockstargames.gtav.constants.PauseMenuLookup.lookUp(_loc2_.menuID);
                  _loc12_ = _loc6_.menuChanged;
                  _loc13_ = _loc6_.clearRootColumns;
                  _loc7_ = _loc6_.callImmediately;
                  _loc8_ = !_loc7_ && !bIgnoreStateChange;
                  ...
                  if(_loc12_)
                  {
                     ...
                     else if(_loc15_ != _loc2_.menuID || _loc14_ != _loc2_.uniqueID || _loc16_ != _loc2_.index)
                     {
   ...
   function TRIGGER_PAUSE_MENU_EVENT()
   {
      ...
      if(this.menuLevel > 0)
      {
         ...
         if(_loc6_ != undefined)
         {
            _loc4_ = this.getSelectedMenuItem(_loc6_);
            ...
            if(_loc2_.uniqueID != undefined || _loc2_.uniqueID != null)
            {
               _loc7_ = _loc2_.uniqueID;
            }
            if(_loc4_ != undefined)
            {
               com.rockstargames.ui.game.GameInterface.call("TRIGGER_PAUSE_MENU_EVENT",com.rockstargames.ui.game.GameInterface.PAUSE_TYPE,_loc4_.menuID,_loc4_.uniqueID,_loc3_,_loc7_);
               this.dbg("TRIGGER_PAUSE_MENU_EVENT | currMenuItem.menuID: " + _loc4_.menuID + " | currMenuItem.uniqueID: " + _loc4_.uniqueID + " nextMenuID: " + _loc3_);
            }
         }
      }
      else
      {
         _loc5_ = this.menuList[this.menuIndex];
