class com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform
{
   ...
   function nextEditStep()
   {
      ...
      if(_loc3_ == 0)
      {
         var _loc4_ = this.rightEdge - this.view._width;
         var _loc8_ = this.leftEdge;
         var _loc9_ = Math.random() * (_loc8_ - _loc4_) + _loc4_;
         var _loc2_ = Math.random() * (com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MAX_SCRUB_DURATION - com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MIN_SCRUB_DURATION) + com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MIN_SCRUB_DURATION;
      ...
      {
         var _loc7_ = Math.random() * (com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MAX_X_SCALE - com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MIN_X_SCALE) + com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MIN_X_SCALE;
         var _loc6_ = Math.random() * (com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MAX_Y_SCALE - com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MIN_Y_SCALE) + com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MIN_Y_SCALE;
      ...
      {
         var _loc5_ = Math.random() * (com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MAX_OVERLAY_WIDTH - com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MIN_OVERLAY_WIDTH) + com.rockstargames.gtav.levelDesign.musicStudioMonitor.Waveform.MIN_OVERLAY_WIDTH;
