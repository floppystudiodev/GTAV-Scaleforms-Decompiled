class com.rockstargames.gtav.web.WWW_LEGENDARYMOTORSPORT_NET extends com.rockstargames.gtav.web.WWW_LEGENDARYMOTORSPORT_NET_WRAPPER
{
   ...
   function filterVehicles()
   {
      if(this.isMP)
      {
         this.categoryOrder = ["LMS_POPULAR","LMS_2DOOR","LMS_4DOOR","LMS_MOTORCYCLES","LMS_OPENWHEEL"];
         this.vehicles = {LMS_POPULAR:[this.vehicles.HORUS,this.vehicles.WARDEN,this.vehicles.VELENOGT,this.vehicles.CARTUCCIA,this.vehicles.LRCGT,this.vehicles.NIOBE,this.vehicles.SENTINEL5,this.vehicles.BANSHEE3,this.vehicles.SHOTARO,this.vehicles.FMJ2,this.vehicles.HAKUCHOU2,this.vehicles.EVERON3,this.vehicles.STINGERTT],LMS_2DOOR:[this.vehicles.HORUS,this.vehicles.VELENOGT,this.vehicles.CARTUCCIA,this.vehicles.LRCGT,this.vehicles.ITALI2,this.vehicles.ASTRALE,this.vehicles.LUIVA,this.vehicles.GT750,this.vehicles.XTREME,this.vehicles.FMJ2,this.vehicles.CHEETAH3,this.vehicles.SUZUME,this.vehicles.EVERON3,this.vehicles.RAPIDGT4,this.vehicles.COQUETTE6,this.vehicles.JESTER5,this.vehicles.BANSHEE3,this.vehicles.PIPISTRELLO,this.vehicles.COQUETTE5,this.vehicles.EUROSX32,this.vehicles.NIOBE,this.vehicles.PARAGON3,this.vehicles.ENVISAGE,this.vehicles.TURISMO3,this.vehicles.COUREUR,this.vehicles.BUFFALO5,this.vehicles.STINGERTT,this.vehicles.VIRTUE,this.vehicles.PANTHERE,this.vehicles.BROADWAY,this.vehicles
         .R300,this.vehicles.ENTITY3,this.vehicles.TENF,this.vehicles.SM722,this.vehicles.TORERO2,this.vehicles.CORSITA,this.vehicles.LM87,this.vehicles.CYCLONE2,this.vehicles.COMET7,this.vehicles.ZENO,this.vehicles.IGNUS,this.vehicles.CHAMPION,this.vehicles.CYPHER,this.vehicles.GROWLER,this.vehicles.VECTRE,this.vehicles.COMET6,this.vehicles.JESTER4,this.vehicles.ZR350,this.vehicles.EUROS,this.vehicles.ITALIRSX,this.vehicles.TIGON,this.vehicles.COQUETTE4,this.vehicles.IMORGON,this.vehicles.FURIA,this.vehicles.ZORRUSSO,this.vehicles.KRIEGER,this.vehicles.LOCUST,this.vehicles.EMERUS,this.vehicles.NEO,this.vehicles.THRAX,this.vehicles.PARAGON,this.vehicles.S80,this.vehicles.DRAFTER,this.vehicles.DEVESTE,this.vehicles.DEVIANT,this.vehicles.SCHLAGEN,this.vehicles.ITALIGTO,this.vehicles.CLIQUE,this.vehicles.SWINGER,this.vehicles.JESTER3,this.vehicles.TYRANT,this.vehicles.FLASHGT,this.vehicles.TEZERACT,this.vehicles.ENTITY2,this.vehicles.TAIPAN,this.vehicles.GB200,this.vehicles.COMET5,this.vehicles.HUSTLER,this
         .vehicles.Z190,this.vehicles.GT500,this.vehicles.VISERIS,this.vehicles.SAVESTRA,this.vehicles.AUTARCH,this.vehicles.COMET4,this.vehicles.PARIAH,this.vehicles.SC1,this.vehicles.CYCLONE,this.vehicles.RAPIDGT3,this.vehicles.VISIONE,this.vehicles.XA21,this.vehicles.TORERO,this.vehicles.CHEETAH2,this.vehicles.VAGNER,this.vehicles.TURISMO2,this.vehicles.INFERNUS2,this.vehicles.RUSTON,this.vehicles.GP1,this.vehicles.TEMPESTA,this.vehicles.PENETRATOR,this.vehicles.RAPTOR,this.vehicles.LYNX,this.vehicles.SHEAVA,this.vehicles.TYRUS,this.vehicles.LE7B,this.vehicles.REAPER,this.vehicles.PROTOTIPO,this.vehicles.SEVEN70,this.vehicles.PFISTER811,this.vehicles.FMJ,this.vehicles.BESTIAGTS,this.vehicles.NITESHAD,this.vehicles.VERLIER,this.vehicles.MAMBA,this.vehicles.BRAWLER,this.vehicles.CHINO,this.vehicles.COQUETTE3,this.vehicles.T20,this.vehicles.OSIRIS,this.vehicles.FELTZER3,this.vehicles.VIRGO,this.vehicles.WINDSOR,this.vehicles.CASCO,this.vehicles.FURORE,this.vehicles.COQUETTE2,this.vehicles.COQUETTE2_TLESS,this
         .vehicles.MASSACRO,this.vehicles.STINGER_TLESS,this.vehicles.COQUETTE_TLESS,this.vehicles.VOLTIC_HTOP,this.vehicles.BANSHEE_TLESS,this.vehicles.ZENTORNO,this.vehicles.JESTER,this.vehicles.TURISMOR,this.vehicles.ALPHA,this.vehicles.KHAMEL,this.vehicles.HOTKNIFE,this.vehicles.ELEGY2,this.vehicles.ZTYPE,this.vehicles.STINGER,this.vehicles.STINGERG,this.vehicles.JB700,this.vehicles.CHEETAH,this.vehicles.ENTITYXF,this.vehicles.ADDER,this.vehicles.MONROE,this.vehicles.COGCABRI,this.vehicles.VACCA,this.vehicles.BULLET,this.vehicles.CARBONIZ,this.vehicles.COQUETTE,this.vehicles.FELTZER,this.vehicles.INFERNUS,this.vehicles.NINEF,this.vehicles.NINEF2,this.vehicles.RAPIDGT,this.vehicles.RAPIDGT2,this.vehicles.VOLTIC_TLESS,this.vehicles.COMET2,this.vehicles.SURANO_CONVERTABLE,this.vehicles.BANSHEE],LMS_4DOOR:[this.vehicles.WARDEN,this.vehicles.SENTINEL5,this.vehicles.BALLER8,this.vehicles.ALEUTIAN,this.vehicles.OMNISEGT,this.vehicles.ASTRON2,this.vehicles.BALLER7,this.vehicles.ASTRON,this.vehicles.CINQUEMILA,this
         .vehicles.JUBILEE,this.vehicles.DEITY,this.vehicles.TAILGATER2,this.vehicles.VSTR,this.vehicles.KOMODA,this.vehicles.REBLA,this.vehicles.NOVAK,this.vehicles.JUGULAR,this.vehicles.TOROS,this.vehicles.FREECRAWLER,this.vehicles.STAFFORD,this.vehicles.NEON,this.vehicles.REVOLTER,this.vehicles.RAIDEN,this.vehicles.XLS,this.vehicles.WINDSOR2,this.vehicles.ROOSEVELT2,this.vehicles.ROOSEVELT,this.vehicles.COG55,this.vehicles.COGNOSC,this.vehicles.BALLER3,this.vehicles.BALLER4,this.vehicles.SCHAFTER3,this.vehicles.SCHAFTER4,this.vehicles.HUNTLEY,this.vehicles.EXEMPLAR,this.vehicles.SUPERD],LMS_MOTORCYCLES:[this.vehicles.POWERSURGE,this.vehicles.REEVER,this.vehicles.SHINOBI,this.vehicles.STRYDER,this.vehicles.RROCKET,this.vehicles.SHOTARO,this.vehicles.HAKUCHOU2,this.vehicles.VINDICATOR,this.vehicles.LECTRO,this.vehicles.THRUST,this.vehicles.CARBON],LMS_OPENWHEEL:[this.vehicles.OPENWHEEL1,this.vehicles.OPENWHEEL2,this.vehicles.FORMULA,this.vehicles.FORMULA2]};
      }
      else
      {
