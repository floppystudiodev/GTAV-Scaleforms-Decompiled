class com.rockstargames.gtav.pauseMenuPages.PAUSE_MENU_PAGES_CREWS extends com.rockstargames.gtav.pauseMenuPages.PauseMenuBasePage
{
   ...
   function setupPage()
   {
      ...
      com.rockstargames.gtav.pauseMenu.pauseMenuItems.singleplayer.PauseMenuCrewListView(_loc3_).sidecarColumn = com.rockstargames.gtav.pauseMenu.pauseMenuItems.PauseMenuViewBase(_loc4_);
