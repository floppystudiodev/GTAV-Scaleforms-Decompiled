class com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS extends com.rockstargames.ui.core.BaseScreenLayout
{
   var TIMELINE;
   var BOUNDING_BOX;
   var CONTENT;
   ...
   function MUSIC_STUDIO_MONITOR_CS()
   {
      super();
      _global.gfxExtensions = true;
      this._name = "MUSIC_STUDIO_MONITOR_CS";
   }
   function initialise(mc, initState)
   {
      this.TIMELINE = mc;
      this.BOUNDING_BOX = this.TIMELINE.attachMovie("BOUNDING_BOX","BOUNDING_BOX",this.TIMELINE.getNextHighestDepth());
      this.BOUNDING_BOX._visible = false;
      this.CONTENT = this.TIMELINE.attachMovie("CONTENT","CONTENT",this.TIMELINE.getNextHighestDepth());
      this.state = com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.STATE_NULL;
      this.updateArgs = {onCompleteScope:this,onComplete:this.update};
      this.noise = new com.rockstargames.ui.utils.Perlin1D();
      this.meters = [];
      var _loc2_ = 0;
      while(_loc2_ < com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.NUM_METERS)
      {
      ...
      this.faders = [];
      _loc2_ = 0;
      while(_loc2_ < com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.NUM_FADERS)
      {
   ...
   function SET_STATE(state)
   {
      if(this.state != state)
      {
         ...
         switch(state)
         {
            case com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.STATE_OFF:
               this.waveform.stopEdit();
               this.CONTENT.sequencer._visible = false;
               break;
            case com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.STATE_EDIT:
               ...
               this.CONTENT.sequencer._visible = false;
               break;
            case com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.STATE_PLAY:
               this.faderStepTimestamp = getTimer();
               this.faderStep = 0;
               ...
               this.CONTENT.sequencer._visible = false;
               break;
            case com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.STATE_SEQ:
               this.faderStepTimestamp = getTimer();
               this.faderStep = 0;
               this.playTimestamp = getTimer();
               this.waveform.stopEdit();
               this.shuffleArray(this.meters);
               this.shuffleArray(this.faders);
               this.CONTENT.sequencer._visible = true;
         }
      }
   }
   function update()
   {
      switch(this.state)
      {
         ...
         case com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.STATE_EDIT:
            ...
            this.updateFaders(com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.NUM_ACTIVE_FADERS_WHEN_EDITING[this.faderStep % com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.NUM_ACTIVE_FADERS_WHEN_EDITING.length]);
            this.updateLEDs(0.05);
            break;
         case com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.STATE_PLAY:
            this.setTime(getTimer() - this.playTimestamp);
            this.waveform.updatePlayback();
            this.updateMeters(com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.NUM_ACTIVE_METERS_WHEN_PLAYING);
            this.updateFaders(com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.NUM_ACTIVE_FADERS_WHEN_PLAYING[this.faderStep % com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.NUM_ACTIVE_FADERS_WHEN_PLAYING.length]);
      ...
      com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.CONTENT,com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.FRAME_DURATION,this.updateArgs);
   }
   ...
   {
      var _loc2_ = com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.SEGS[digit];
      var _loc1_ = 0;
      while(_loc1_ < com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.NUM_SEGMENTS)
      {
   ...
   function updateLEDs(rate)
   {
      if(Math.random() < rate)
      {
         var _loc2_ = Math.floor(Math.random() * com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.NUM_LEDS);
   ...
   function updateFaders(updateThreshold)
   {
      ...
      var _loc4_ = getTimer();
      if(_loc4_ - this.faderStepTimestamp > com.rockstargames.gtav.levelDesign.MUSIC_STUDIO_MONITOR_CS.FADER_STEP_DURATION)
      {
