class com.rockstargames.gtav.web.dynasty8ExecutiveRealty.AgencyVehiclePage extends com.rockstargames.gtav.web.dynasty8ExecutiveRealty.Page
{
   var nextPageName;
   var prevPageName;
   var progressPanel;
   ...
   static var IMAGES = ["WORKSHOP"];
   function AgencyVehiclePage(website, viewContainer, pageName, isFirstPage, progressPanel, header)
   {
      super(website,viewContainer,"agencyVehiclePage",pageName,isFirstPage,progressPanel,header);
      this.init();
   }
   function init()
   {
      ...
      com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setSpacedTextField(this.view.description,"DYN8_EXEC_AG_WORKSHOP_DESC",false);
   ...
   function initSlideshow()
   {
      ...
      this.slideshow.show(com.rockstargames.gtav.web.dynasty8ExecutiveRealty.AgencyVehiclePage.TXD,com.rockstargames.gtav.web.dynasty8ExecutiveRealty.AgencyVehiclePage.IMAGES);
   }
   function initOptionButton(buttonView)
   {
      ...
      com.rockstargames.gtav.web.WWW_DYNASTY8EXECUTIVEREALTY_COM.setSpacedTextField(buttonView.btnTxt,"DYN8_EXEC_AG_WORKSHOP",false);
      if(!this.website.getSelectedAgency().isOwned || this.website.purchasedAgencyVehicle == 0)
      {
   ...
   function handleClick(type, id)
   {
      ...
      {
         case "optionButton":
            this.website.agencyVehicle = this.website.agencyVehicle != 0 ? 0 : 1;
            this.updateSelectedItem();
            break;
         case "purchaseButton":
   ...
   {
      this.view.optionButton.tick._visible = this.website.agencyVehicle == 1;
