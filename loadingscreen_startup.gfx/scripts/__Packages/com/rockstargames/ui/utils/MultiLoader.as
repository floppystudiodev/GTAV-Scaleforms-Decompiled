class com.rockstargames.ui.utils.MultiLoader
{
   ...
   function getGroupProgress()
   {
      ...
      while(_loc2_ < this._clips.length)
      {
         _loc4_ += this._loaders[_loc2_].getProgress(this._clips[_loc2_].target).bytesLoaded;
         _loc3_ += this._loaders[_loc2_].getProgress(this._clips[_loc2_].target).bytesTotal;
         _loc2_ = _loc2_ + 1;
      }
      if(this._falseTotal)
      {
