class com.rockstargames.gtav.web.arena.ImageManager
{
   ...
   {
      if(com.rockstargames.gtav.web.arena.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == com.rockstargames.gtav.web.arena.ImageManager.TXD_LOADED)
      {
         this.displayImage(txd,id,imageMovieClip,fadeInWhenLoaded);
      }
      else
      {
         if(this.txdRefs[txd] != com.rockstargames.gtav.web.arena.ImageManager.TXD_LOADING)
         {
            this.txdRefs[txd] = com.rockstargames.gtav.web.arena.ImageManager.TXD_LOADING;
   ...
   function displayImage(txd, id, imageMovieClip, fadeIn)
   {
      ...
      if(fadeIn)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.to(imageMovieClip,com.rockstargames.gtav.web.arena.ImageManager.FADE_IN_DURATION,{_alpha:100});
      }
   }
   function dispose()
   {
