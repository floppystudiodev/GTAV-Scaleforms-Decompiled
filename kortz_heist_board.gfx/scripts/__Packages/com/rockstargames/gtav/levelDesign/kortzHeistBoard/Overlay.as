class com.rockstargames.gtav.levelDesign.kortzHeistBoard.Overlay
{
   var actionButtons;
   var view;
   ...
   function init()
   {
      ...
      this.actionButtons = [];
      this.actionButtons.push(new com.rockstargames.gtav.levelDesign.kortzHeistBoard.Button(com.rockstargames.gtav.levelDesign.kortzHeistBoard.ButtonIDs.OVERLAY_CANCEL,this.view.cancelButton));
      this.actionButtons.push(new com.rockstargames.gtav.levelDesign.kortzHeistBoard.Button(com.rockstargames.gtav.levelDesign.kortzHeistBoard.ButtonIDs.OVERLAY_ACCEPT,this.view.acceptButton));
   ...
   function show(title, message, acceptButtonLabel, cancelButtonLabel, showImmediately)
   {
      ...
      this.view.title._y = 0.5 * (com.rockstargames.gtav.levelDesign.kortzHeistBoard.Overlay.HEIGHT - _loc6_);
      ...
      {
         this.view.acceptButton._x = Math.floor(com.rockstargames.gtav.levelDesign.kortzHeistBoard.Overlay.CENTRE_X - 0.5 * this.view.acceptButton._width);
         this.view.cancelButton._x = com.rockstargames.gtav.levelDesign.kortzHeistBoard.Overlay.CENTRE_X << 1;
      }
      else if(acceptButtonLabel.length == 0)
      {
         this.view.cancelButton._x = Math.floor(com.rockstargames.gtav.levelDesign.kortzHeistBoard.Overlay.CENTRE_X - 0.5 * this.view.cancelButton._width);
         this.view.acceptButton._x = com.rockstargames.gtav.levelDesign.kortzHeistBoard.Overlay.CENTRE_X << 1;
      }
      else
      {
      ...
      if(!showImmediately)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.screenBG,com.rockstargames.gtav.levelDesign.kortzHeistBoard.Overlay.ELEMENT_FADE_IN_DURATION,{_alpha:90,ease:com.rockstargames.ui.tweenStar.Ease.QUARTIC_OUT});
      }
