class com.rockstargames.gtav.levelDesign.kortzHeistBoard.TodoList
{
   var items;
   var nextItemY;
   var view;
   ...
   {
      this.view = view;
      this.nextItemY = com.rockstargames.gtav.levelDesign.kortzHeistBoard.TodoList.ROW_TOP_OFFSET;
      com.rockstargames.gtav.levelDesign.KORTZ_HEIST_BOARD.setLocalisedText(view.title,titleLabel);
   ...
   function addItem(itemText, isComplete)
   {
      ...
      this.nextItemY += _loc2_._height + com.rockstargames.gtav.levelDesign.kortzHeistBoard.TodoList.ROW_SPACING;
