class com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor
{
   var view;
   var bounds;
   var targets;
   ...
   function joystick(dx, dy)
   {
      ...
      dy = (dy - 127) / 127;
      var _loc2_ = getTimer();
      var _loc6_ = this.clamp(_loc2_ - this.joystickTimestamp,0,com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.MAX_JOYSTICK_CALL_INTERVAL);
      var _loc3_ = com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.JOYSTICK_SPEED * _loc6_;
   ...
   {
      this.snapToTarget(this.getTargetByID(id));
   }
   ...
   function tweenTo(goalX, goalY)
   {
      ...
      var _loc4_ = _loc6_ / com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.ANIMATION_SPEED;
      var _loc5_ = getTimer();
   ...
   function updateTween(startX, startY, dx, dy, duration, startTime)
   {
      ...
      if(_loc3_ < 1)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.TWEEN_UPDATE_INTERVAL,this.tweenArgs);
      }
      else
      {
         this.stopTween();
   ...
   function findTargetInDirection(direction)
   {
      ...
      {
         if(direction == com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.LEFT && this.activeTarget.navLeft != undefined)
         {
            trace("found navleft");
            return this.getTargetByID(this.activeTarget.navLeft);
         }
         if(direction == com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.RIGHT && this.activeTarget.navRight != undefined)
         {
            trace("found navright");
            return this.getTargetByID(this.activeTarget.navRight);
         }
         if(direction == com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.UP && this.activeTarget.navUp != undefined)
         {
            trace("found navup");
            return this.getTargetByID(this.activeTarget.navUp);
         }
         if(direction == com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.DOWN && this.activeTarget.navDown != undefined)
         {
            trace("found navdown");
            return this.getTargetByID(this.activeTarget.navDown);
         }
      }
      var _loc13_ = direction == com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.LEFT || direction == com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.RIGHT;
      ...
      while(_loc7_ < _loc10_)
      {
         ...
         if(!(!_loc2_.enabled || _loc2_ == this.activeTarget))
         {
            if(_loc13_)
            {
               _loc6_ = direction != com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.LEFT ? _loc2_.cx - this.x : this.x - _loc2_.cx;
               _loc3_ = _loc2_.t - this.y;
               _loc4_ = _loc2_.b - this.y;
            }
            else
            {
               _loc6_ = direction != com.rockstargames.gtav.levelDesign.bountyComputer.navigation.Cursor.UP ? _loc2_.cy - this.y : this.y - _loc2_.cy;
   ...
   function getTargetByID(id)
   {
      ...
      trace("no matching button with id " + id);
      return null;
   }
   function debugDraw()
   {
