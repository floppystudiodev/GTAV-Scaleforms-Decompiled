class com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor
{
   var activeTarget;
   var bounds;
   var debugColour;
   ...
   function joystick(dx, dy)
   {
      ...
      dy = (dy - 127) / 127;
      var _loc2_ = getTimer();
      var _loc6_ = this.clamp(_loc2_ - this.joystickTimestamp,0,com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.MAX_JOYSTICK_CALL_INTERVAL);
      var _loc3_ = com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.JOYSTICK_SPEED * _loc6_;
   ...
   function snapInDirection(direction)
   {
      ...
      if(_loc2_)
      {
         if(direction == com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.LEFT || direction == com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.RIGHT)
         {
            com.rockstargames.gtav.levelDesign.AVENGER_OPERATIONS_TERMINAL.playSound("Nav_Left_Right");
         }
         else
         {
            com.rockstargames.gtav.levelDesign.AVENGER_OPERATIONS_TERMINAL.playSound("Nav_Up_Down");
         }
         this.x = _loc2_.cx;
         this.y = _loc2_.cy;
         this.update();
      ...
      {
         com.rockstargames.gtav.levelDesign.AVENGER_OPERATIONS_TERMINAL.playSound("Nav_Blocked");
      }
   }
   function update()
   {
   ...
   function tweenTo(goalX, goalY)
   {
      ...
      var _loc4_ = _loc6_ / com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.ANIMATION_SPEED;
      var _loc5_ = getTimer();
   ...
   function updateTween(startX, startY, dx, dy, duration, startTime)
   {
      ...
      if(_loc3_ < 1)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.TWEEN_UPDATE_INTERVAL,this.tweenArgs);
      }
      else
      {
         this.stopTween();
   ...
   {
      var _loc13_ = direction == com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.LEFT || direction == com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.RIGHT;
      var _loc6_;
      var _loc9_;
      var _loc3_;
      var _loc4_;
      ...
      while(_loc7_ < _loc10_)
      {
         ...
         if(!(!_loc2_.enabled || _loc2_ == this.activeTarget))
         {
            if(_loc13_)
            {
               _loc6_ = direction != com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.LEFT ? _loc2_.cx - this.x : this.x - _loc2_.cx;
               _loc3_ = _loc2_.t - this.y;
               _loc4_ = _loc2_.b - this.y;
            }
            else
            {
               _loc6_ = direction != com.rockstargames.gtav.levelDesign.avengerOperationsTerminal.ui.Cursor.UP ? _loc2_.cy - this.y : this.y - _loc2_.cy;
