class com.rockstargames.gtav.web.DynamicGraph extends MovieClip
{
   ...
   static function draw(labelsDataArray, graphDataArray, graphMovieClip, plotColour)
   {
      ...
      {
         _loc6_ = new Array(0,-0.37,0.27,-0.18,0.3,-0.09,0.26,0.09,0.46,-0.3,0.1,0.27,0.07,-0.27,0.13,0.48,0.17,-0.15,0.06,0.18,0.49);
         ...
         _loc28_ = com.rockstargames.gtav.web.DynamicGraph.highVal - com.rockstargames.gtav.web.DynamicGraph.lowVal;
         _loc26_ = Math.ceil(10 * _loc28_ / 4) / 10;
         _loc28_ = 4 * _loc26_;
         com.rockstargames.gtav.web.DynamicGraph.highVal = com.rockstargames.gtav.web.DynamicGraph.lowVal + _loc28_;
         _loc21_ = com.rockstargames.gtav.web.DynamicGraph.normalizeArray(graphDataArray,_loc28_);
         _loc18_ = _loc21_.length;
         _loc8_ = labelsDataArray[6];
         if(_loc8_ == undefined)
         {
            _loc8_ = 0;
            _loc24_ = 0;
         ...
         _loc27_ = 0;
         _loc23_ = graphMovieClip.drawArea._width;
         _loc7_ = 0;
         _loc4_ = graphMovieClip.drawArea._height;
         ...
         _loc29_ = graphMovieClip.getNextHighestDepth();
         ...
         _loc20_ = graphMovieClip.createEmptyMovieClip("graphLine",graphMovieClip.getNextHighestDepth());
         ...
         while(_loc16_ < 5)
         {
            ...
            _loc11_ = com.rockstargames.gtav.web.DynamicGraph.lowVal + _loc26_ * _loc16_;
