class com.rockstargames.gtav.levelDesign.islandHeistBoard.ui.ImageManager
{
   var gfxName;
   var txdRefs;
   var imageQueue;
   ...
   function addImage(txd, texture, imageMovieClip)
   {
      ...
      if(com.rockstargames.gtav.levelDesign.islandHeistBoard.ui.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == com.rockstargames.gtav.levelDesign.islandHeistBoard.ui.ImageManager.TXD_LOADED)
      {
         this.displayImage(txd,texture,imageMovieClip);
      }
      else
      {
         if(this.txdRefs[txd] != com.rockstargames.gtav.levelDesign.islandHeistBoard.ui.ImageManager.TXD_LOADING)
         {
            this.txdRefs[txd] = com.rockstargames.gtav.levelDesign.islandHeistBoard.ui.ImageManager.TXD_LOADING;
   ...
   {
      this.txdRefs[txd] = com.rockstargames.gtav.levelDesign.islandHeistBoard.ui.ImageManager.TXD_LOADED;
