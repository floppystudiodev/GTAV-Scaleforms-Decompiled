class com.rockstargames.gtav.levelDesign.celebration.steps.RPAndRankBarStep extends com.rockstargames.gtav.levelDesign.celebration.steps.Step
{
   ...
   function start()
   {
      ...
      this.sequence.playSound("RP_Appear",com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.SOUNDSET);
   }
   function finish()
   {
      super.finish();
   ...
   function startCounter()
   {
      ...
      this.counterStep = 0;
      com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.ONE_FRAME,{onCompleteScope:this,onComplete:this.updateCounter,onCompleteArgs:[0,this.repPointsGained,_loc2_]});
   }
   function updateCounter(startValue, delta, duration)
   {
      ...
      if(delta != 0)
      {
         this.sequence.playSound("RP_Counter",com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.SOUNDSET);
      }
      if(_loc2_ == 1)
      {
         com.rockstargames.ui.tweenStar.TweenStarLite.removeTweenOf(this.view);
         ...
         {
            com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.POST_POINTS_COUNT_PAUSE,{onComplete:this.showRankUp,onCompleteScope:this});
         }
         else
         {
            com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.POST_STEP_PAUSE,{onComplete:this.stepComplete,onCompleteScope:this});
         }
      }
      else
      {
   ...
   {
      this.sequence.setGlobalFlag(com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.BACKGROUND_START_TWEEN_OUT);
   ...
   function showRankUp()
   {
      ...
      this.sequence.setGlobalFlag(com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.BACKGROUND_START_TWEEN_OUT);
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.content.rankup,com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION,{_y:_loc6_,ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN,onComplete:this.startRankUpSpinAnimation,onCompleteScope:this});
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.content.rank,com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION,{_alpha:0,ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN});
      var _loc5_ = - this.view._parent._y - this.view._y + 670;
      this.sequence.pushDownSteps(_loc5_,com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION);
   ...
   {
      this.sequence.setGlobalFlag(com.rockstargames.gtav.levelDesign.celebration.CelebrationSequence.BACKGROUND_HALFWAY_TWEEN_OUT);
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.content.rankup.rankNumberMc,0.8 * com.rockstargames.gtav.levelDesign.celebration.steps.RPAndRankBarStep.RANKUP_SPIN_DURATION,{_xscale:0,ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN,onCompleteScope:this,onComplete:this.finishRankUpSpinAnimation});
   ...
   function finishRankUpSpinAnimation()
   {
      ...
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.content.rankup.rankNumberMc,0.2 * com.rockstargames.gtav.levelDesign.celebration.steps.RPAndRankBarStep.RANKUP_SPIN_DURATION,{_xscale:100,onCompleteScope:this,onComplete:this.showRankUpGlow});
   }
