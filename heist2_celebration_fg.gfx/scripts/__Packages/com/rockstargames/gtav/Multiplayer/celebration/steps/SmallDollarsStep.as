class com.rockstargames.gtav.Multiplayer.celebration.steps.SmallDollarsStep extends com.rockstargames.gtav.Multiplayer.celebration.steps.Step
{
   var counterStep;
   var description;
   var initialised;
   ...
   function init(container, y)
   {
      ...
      _loc3_.value._x = (!com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.IS_WIDESCREEN ? 1090 : 1170) - 27 * _loc8_;
      var _loc5_ = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_WIDTH - 2 * _loc3_.title._x;
   ...
   function startCashCounter()
   {
      ...
      this.counterStep = 0;
      com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.ONE_FRAME,{onCompleteScope:this,onComplete:this.updateCashCounter,onCompleteArgs:[0,this.value,_loc2_]});
   }
   function updateCashCounter(startValue, delta, duration)
   {
      ...
      {
         com.rockstargames.ui.tweenStar.TweenStarLite.removeTweenOf(this.view);
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.POST_POINTS_COUNT_PAUSE,{onComplete:this.sequence.currentStepComplete,onCompleteScope:this.sequence});
      }
      else
      {
