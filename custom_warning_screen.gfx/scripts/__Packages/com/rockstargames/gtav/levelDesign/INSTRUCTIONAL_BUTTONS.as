class com.rockstargames.gtav.levelDesign.INSTRUCTIONAL_BUTTONS extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function drawButton(mc, inputID)
   {
      ...
      _loc3_.moveTo(0,0);
      _loc3_.lineTo(_loc4_,0);
      _loc3_.lineTo(_loc4_,_loc5_);
      _loc3_.lineTo(0,_loc5_);
      _loc3_.lineTo(0,0);
      _loc3_.endFill();
      _loc3_._alpha = !this.debugDrawHitArea ? 0 : 100;
   ...
   function SET_BACKGROUND()
   {
      ...
      while(_loc2_ < this.backgrounds.length)
      {
         ...
         if(this.CLICKABLE)
         {
            ...
            this._backgroundMouseCatcher.beginFill(16711935,100);
            this._backgroundMouseCatcher.moveTo(0,0);
            this._backgroundMouseCatcher.lineTo(_loc3_ + this.BACKGROUND_PADDING,0);
            this._backgroundMouseCatcher.lineTo(_loc3_ + this.BACKGROUND_PADDING,this.iconSize + this.BACKGROUND_PADDING);
            ...
            this._backgroundMouseCatcher._alpha = 0;
   ...
   function generateTextField(textFieldName, textString, parentMovieClip)
   {
      ...
      {
         _loc3_ = textString.split("PlayStation");
         if(_loc3_.length > 1)
         {
            _loc5_ = textString.split("Store");
            if(_loc5_.length > 1)
            {
               textString = "";
   ...
   function debug()
   {
      ...
      this.SET_DATA_SLOT(3,"b_1009","b_1005","Player List",1,78);
