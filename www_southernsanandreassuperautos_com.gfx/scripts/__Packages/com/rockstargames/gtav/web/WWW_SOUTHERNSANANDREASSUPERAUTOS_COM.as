class com.rockstargames.gtav.web.WWW_SOUTHERNSANANDREASSUPERAUTOS_COM extends com.rockstargames.gtav.web.WWW_SOUTHERNSANANDREASSUPERAUTOS_COM_WRAPPER
{
   ...
   function filterVehicles()
   {
      ...
      if(this.isMP)
      {
         this.categoryOrder = ["SSSA_POPULAR","SSSA_2DOOR","SSSA_4DOOR","SSSA_OFFROAD","SSSA_LUXURY","SSSA_MOTORBIKES","SSSA_KARTS"];
         this.vehicles = {SSSA_POPULAR:[this.vehicles.LAUFER,this.vehicles.MERULA,this.vehicles.ESTRIDE,this.vehicles.BUFFALO4,this.vehicles.VIGERO2,this.vehicles.GAUNTLET4,this.vehicles.CAVALCADE3,this.vehicles.FIREBOLT,this.vehicles.CARACARA2,this.vehicles.DOMINATOR9,this.vehicles.TAMPA4],SSSA_2DOOR:[this.vehicles.KEITORA,this.vehicles.DRIFTL352,this.vehicles.L352,this.vehicles.TAMPA4,this.vehicles.URANUS,this.vehicles.FIREBOLT,this.vehicles.DOMINATOR10,this.vehicles.YOSEMITE4,this.vehicles.DOMINATOR9,this.vehicles.VIGERO3,this.vehicles.FR36,this.vehicles.GAUNTLET6,this.vehicles.CLIQUE2,this.vehicles.MONSTROCITI,this.vehicles.RATEL,this.vehicles.L35,this.vehicles.BOOR,this.vehicles.EVERON2,this.vehicles.TAHOMA,this.vehicles.TULIP2,this.vehicles.POSTLUDE,this.vehicles.KANJOSJ,this.vehicles.VIGERO2,this.vehicles.RUINER4,this.vehicles.S95,this.vehicles.ARBITERGT,this.vehicles.PREVION,this.vehicles.SULTAN3,this.vehicles.DOMINATOR7,this.vehicles.DOMINATOR8,this.vehicles.FUTO2,this.vehicles.REMUS,this
         .vehicles.CALICO,this.vehicles.WARRENER2,this.vehicles.RT3000,this.vehicles.BRIOSO2,this.vehicles.SLAMTRUCK,this.vehicles.WEEVIL,this.vehicles.PENUMBRA2,this.vehicles.CLUB,this.vehicles.DUKES3,this.vehicles.KANJO,this.vehicles.YOSEMITE2,this.vehicles.RETINUE2,this.vehicles.ASBO,this.vehicles.PEYOTE2,this.vehicles.ZION3,this.vehicles.GAUNTLET4,this.vehicles.NEBULA,this.vehicles.GAUNTLET3,this.vehicles.ISSI7,this.vehicles.IMPALER,this.vehicles.VAMOS,this.vehicles.BLISTA3,this.vehicles.FUTO,this.vehicles.RUINER,this.vehicles.ROMERO,this.vehicles.PRAIRIE,this.vehicles.MICHELLI,this.vehicles.DOMINATOR3,this.vehicles.ISSI3,this.vehicles.ELLIE,this.vehicles.FAGALOA,this.vehicles.HOTRING,this.vehicles.HERMES,this.vehicles.SENTINEL3,this.vehicles.YOSEMITE,this.vehicles.RETINUE,this.vehicles.TORNADO6,this.vehicles.OMNIS,this.vehicles.TROPOS,this.vehicles.BRIOSO,this.vehicles.TAMPA2,this.vehicles.STALION2,this.vehicles.DOMINATOR2,this.vehicles.GAUNTLET2,this.vehicles.TAMPA,this.vehicles.LURCHER,this
         .vehicles.RLOADER2,this.vehicles.SLAMVAN,this.vehicles.MASSACRO2,this.vehicles.JESTER2,this.vehicles.PIGALLE,this.vehicles.BLADE,this.vehicles.RHAPSODY,this.vehicles.PANTO,this.vehicles.SURFER,this.vehicles.YOUGA,this.vehicles.PICADOR,this.vehicles.DOMINATO,this.vehicles.F620,this.vehicles.FUSILADE,this.vehicles.PENUMBRA,this.vehicles.SENTINEL,this.vehicles.SENTINEL_CONVERTABLE,this.vehicles.RLOADER,this.vehicles.DUKES,this.vehicles.BLISTA2,this.vehicles.STALLION,this.vehicles.SCHWARZE,this.vehicles.ZION,this.vehicles.ZION2,this.vehicles.GAUNTLET,this.vehicles.VIGERO,this.vehicles.ISSI2],SSSA_OFFROAD:[this.vehicles.DRAUGUR,this.vehicles.PATRIOT3,this.vehicles.OUTLAW,this.vehicles.VAGRANT,this.vehicles.HELLION,this.vehicles.CARACARA2,this.vehicles.KAMACHO,this.vehicles.RIATA,this.vehicles.TROPHY,this.vehicles.TROPHY2,this.vehicles.RALLYTRUCK,this.vehicles.SEMINOLE,this.vehicles.RUMPO,this.vehicles.KALAHARI_TOPLESS,this.vehicles.REBEL2,this.vehicles.RANCHERX,this.vehicles.BIFTA,this.vehicles
         .KALAHARI,this.vehicles.SANDKIN2,this.vehicles.BODHI2,this.vehicles.DUNE,this.vehicles.REBEL,this.vehicles.SADLER,this.vehicles.SANDKING,this.vehicles.BFINJECT,this.vehicles.BISON],SSSA_4DOOR:[this.vehicles.LAUFER,this.vehicles.MERULA,this.vehicles.ESTRIDE,this.vehicles.SENTINEL6,this.vehicles.MINIMUS,this.vehicles.HARDY1,this.vehicles.WOODLANDER,this.vehicles.CHAVOSV6,this.vehicles.VORSCHLAG,this.vehicles.CASTIGATOR,this.vehicles.TERMINUS,this.vehicles.IMPALER5,this.vehicles.CAVALCADE3,this.vehicles.DORADO,this.vehicles.ASTEROPE2,this.vehicles.IMPALER6,this.vehicles.VIVANITE,this.vehicles.BRIGHAM,this.vehicles.EUDORA,this.vehicles.ISSI8,this.vehicles.SURFER3,this.vehicles.JOURNEY2,this.vehicles.RHINEHART,this.vehicles.GREENWOOD,this.vehicles.BUFFALO4,this.vehicles.SEMINOLE2,this.vehicles.SUGOI,this.vehicles.SULTAN2,this.vehicles.DYNASTY,this.vehicles.TULIP,this.vehicles.BJXL,this.vehicles.FQ2,this.vehicles.SERRANO,this.vehicles.HABANERO,this.vehicles.CHEBUREK,this.vehicles.STREITER,this
         .vehicles.YOUGA2,this.vehicles.BUFFALO3,this.vehicles.RUMPO3,this.vehicles.BTYPE2,this.vehicles.GUARDIAN,this.vehicles.GBURRITO2,this.vehicles.KURUMA,this.vehicles.KURUMA2,this.vehicles.JACKAL,this.vehicles.ORACLE1,this.vehicles.SCHAFTER2,this.vehicles.SURGE,this.vehicles.WARRENER,this.vehicles.GLENDALE,this.vehicles.REGINA,this.vehicles.PRIMO,this.vehicles.BUFFALO,this.vehicles.BUFFALO2,this.vehicles.TAILGATER,this.vehicles.ASEA,this.vehicles.GRANGER,this.vehicles.INGOT,this.vehicles.INTRUDER,this.vehicles.MINIVAN,this.vehicles.PREMIER,this.vehicles.RADI,this.vehicles.STANIER,this.vehicles.STRATUM,this.vehicles.WASHINGT,this.vehicles.ASTROPE,this.vehicles.PARADISE,this.vehicles.FUGITIVE,this.vehicles.DILETTAN],SSSA_LUXURY:[this.vehicles.GRANGER2,this.vehicles.IWAGEN,this.vehicles.LANDSTLKR2,this.vehicles.EVERON,this.vehicles.PBUS2,this.vehicles.PATRIOT2,this.vehicles.PATRIOT,this.vehicles.CONTENDER,this.vehicles.LANDSTALKER,this.vehicles.GRESLEY,this.vehicles.BOBCATXL,this.vehicles.CAVCADE2,this
         .vehicles.BALLER2,this.vehicles.CAVCADE,this.vehicles.ROCOTO,this.vehicles.FELON,this.vehicles.FELON2,this.vehicles.ORACLE,this.vehicles.STRETCH],SSSA_MOTORBIKES:[this.vehicles.PIZZABOY,this.vehicles.WOLFSBANE,this.vehicles.FAGGIO3,this.vehicles.VORTEX,this.vehicles.BLAZER4,this.vehicles.SANCTUS,this.vehicles.MANCHEZ,this.vehicles.ESSKEY,this.vehicles.NIGHTBLADE,this.vehicles.DEFILER,this.vehicles.AVARUS,this.vehicles.ZOMBIEA,this.vehicles.ZOMBIEB,this.vehicles.CHIMERA,this.vehicles.DAEMON2,this.vehicles.RATBIKE,this.vehicles.BAGGER,this.vehicles.FAGGION,this.vehicles.CLIFFHANGER,this.vehicles.BF400,this.vehicles.GARGOYLE,this.vehicles.ENDURO,this.vehicles.NEMESIS,this.vehicles.HAKUCHOU,this.vehicles.INNOVATION,this.vehicles.SOVEREIGN,this.vehicles.BLAZER3,this.vehicles.SANCHEZ2,this.vehicles.BATI,this.vehicles.BATI2,this.vehicles.RUFFIAN,this.vehicles.VADER,this.vehicles.BLAZER,this.vehicles.PCJ,this.vehicles.SANCHEZ,this.vehicles.FAGGIO,this.vehicles.AKUMA,this.vehicles.DOUBLE,this.vehicles
         .HEXER],SSSA_KARTS:[this.vehicles.VETO2,this.vehicles.VETO,this.vehicles.RCBANDITO]};
      }
      else
      {
