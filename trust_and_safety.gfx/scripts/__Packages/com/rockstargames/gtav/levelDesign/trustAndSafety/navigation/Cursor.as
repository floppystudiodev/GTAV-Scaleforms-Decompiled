class com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor
{
   var activeTarget;
   var bounds;
   var debugColour;
   ...
   function joystick(dx, dy)
   {
      ...
      dy = (dy - 127) / 127;
      var _loc2_ = getTimer();
      var _loc6_ = this.clamp(_loc2_ - this.joystickTimestamp,0,com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor.MAX_JOYSTICK_CALL_INTERVAL);
      var _loc3_ = com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor.JOYSTICK_SPEED * _loc6_;
   ...
   function tweenTo(goalX, goalY)
   {
      ...
      var _loc4_ = _loc6_ / com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor.ANIMATION_SPEED;
      var _loc5_ = getTimer();
   ...
   function updateTween(startX, startY, dx, dy, duration, startTime)
   {
      ...
      if(_loc3_ < 1)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor.TWEEN_UPDATE_INTERVAL,this.tweenArgs);
      }
      else
      {
         this.stopTween();
   ...
   function findTargetInDirection(direction)
   {
      ...
      if(this.activeTarget != null)
      {
         ...
         if(_loc13_ === com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor.NULL_TARGET_ID)
         {
            return null;
         }
      ...
      var _loc14_ = direction == com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor.LEFT || direction == com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor.RIGHT;
      var _loc6_;
      var _loc9_;
      var _loc3_;
      var _loc4_;
      ...
      while(_loc7_ < _loc10_)
      {
         ...
         if(!(!_loc2_.enabled || _loc2_ == this.activeTarget))
         {
            if(_loc14_)
            {
               _loc6_ = direction != com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor.LEFT ? _loc2_.cx - this.x : this.x - _loc2_.cx;
               _loc3_ = _loc2_.t - this.y;
               _loc4_ = _loc2_.b - this.y;
            }
            else
            {
               _loc6_ = direction != com.rockstargames.gtav.levelDesign.trustAndSafety.navigation.Cursor.UP ? _loc2_.cy - this.y : this.y - _loc2_.cy;
