   ...
   function positionToScreen(mc, position, onPixel)
   {
      switch(position)
      {
         ...
         case "xLT":
            ...
            break;
         case "RT":
            mc._x = this.SR - mc._width;
            mc._y = this.ST;
            break;
         case "LB":
            mc._x = this.SL;
            mc._y = this.SB - mc._height;
            break;
         case "RB":
            mc._x = this.SR - mc._width;
            mc._y = this.SB - mc._height;
            break;
         case "CC":
            mc._x = (this.SR + this.safearea.width) * 0.5 - mc._width * 0.5;
            mc._y = (this.SB + this.safearea.height) * 0.5 - mc._height * 0.5;
            break;
         case "CB":
            mc._x = (this.SR + this.safearea.width) * 0.5 - mc._width * 0.5;
            mc._y = this.SB - mc._height;
         ...
         case "xRB":
            ...
            break;
         case "xCC":
            mc._x = (this.SR + this.safearea.width) * 0.5;
            mc._y = (this.SB + this.safearea.height) * 0.5;
            break;
         case "xCB":
            mc._x = (this.SR + this.safearea.width) * 0.5;
            mc._y = this.SB;
