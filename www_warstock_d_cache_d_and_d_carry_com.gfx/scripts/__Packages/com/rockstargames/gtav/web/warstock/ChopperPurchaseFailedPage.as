class com.rockstargames.gtav.web.warstock.ChopperPurchaseFailedPage extends com.rockstargames.gtav.web.warstock.ChopperPage
{
   var buttons;
   var setLocalisedText;
   var view;
   var website;
   function ChopperPurchaseFailedPage(view, website, progressPanel)
   {
