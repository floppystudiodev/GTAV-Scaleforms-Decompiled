class com.rockstargames.gtav.web.warstock.HackerWorkshopPage extends com.rockstargames.gtav.web.warstock.HackerPage
{
   var buttons;
   var nextPageName;
   var prevPageName;
   ...
   var view;
   var website;
   function HackerWorkshopPage(view, website, progressPanel)
   {
   ...
   function init()
   {
      ...
      if(this.website.hackerWorkshop == -1)
      {
         this.website.hackerWorkshop = 0;
      }
      this.website.imageManager.addImage("CANDC_HACKER","WORKSHOP",this.view.image.tf);
      ...
      this.setLocalisedText(this.view.description,"CANDC_HACKER_WORK_DESC");
      var _loc3_ = this.view.selection;
      this.setLocalisedText(_loc3_.btnTxt,"CANDC_HACKER_WORK2");
      _loc3_._y = this.view.description._y + this.view.description.textHeight + 20;
      _loc3_.gotoAndStop(this.website.hackerWorkshop != 1 ? "unselected" : "selected");
