class com.rockstargames.gtav.web.warstock.ChopperTurretPage extends com.rockstargames.gtav.web.warstock.ChopperPage
{
   var buttons;
   var nextPageName;
   var prevPageName;
   ...
   function init()
   {
      ...
      this.website.imageManager.addImage("CANDC_CHOPPER","turret",this.view.image.tf);
      ...
      this.setLocalisedText(this.view.description,"CANDC_CHOPPER_TRT_DESC");
      var _loc3_ = this.view.selection;
      this.setLocalisedText(_loc3_.btnTxt,"CANDC_CHOPPER_TRT");
      _loc3_.gotoAndStop(this.website.chopperTurret != 1 ? "unselected" : "selected");
   ...
   function handleClick(id, attribute)
   {
      ...
      if(id == "selection")
      {
         ...
         if(this.website.chopperTurret == 1)
         {
            this.website.chopperTurret = 0;
            _loc2_.gotoAndStop("unselected");
         }
         else
         {
            this.website.chopperTurret = 1;
