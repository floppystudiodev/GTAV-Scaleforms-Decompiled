class com.rockstargames.gtav.levelDesign.casinoHeistBoardSetup.Button
{
   ...
   function Button(id, view, label, isStringLiteral)
   {
      ...
      view.selected.transform.colorTransform = com.rockstargames.gtav.levelDesign.casinoHeistBoardSetup.Button.RED;
   ...
   function setLabel(label, isStringLiteral)
   {
      if(this.view.label && label)
      {
         ...
         {
            com.rockstargames.gtav.levelDesign.CASINO_HEIST_BOARD_SETUP.setLocalisedText(this.view.label,label);
         }
      }
   }
   ...
   {
      this.view.selected.transform.colorTransform = !isGreyedOut ? com.rockstargames.gtav.levelDesign.casinoHeistBoardSetup.Button.RED : com.rockstargames.gtav.levelDesign.casinoHeistBoardSetup.Button.GREY;
   }
