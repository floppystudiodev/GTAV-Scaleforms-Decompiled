class com.rockstargames.gtav.minigames.horseracingconsole.ImageManager
{
   var gfxName;
   var txdRefs;
   var imageQueue;
   ...
   function addImage(txd, id, imageMovieClip)
   {
      ...
      if(com.rockstargames.gtav.minigames.horseracingconsole.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == com.rockstargames.gtav.minigames.horseracingconsole.ImageManager.TXD_LOADED)
      {
         this.displayImage(txd,id,imageMovieClip);
      }
      else
      {
         if(this.txdRefs[txd] != com.rockstargames.gtav.minigames.horseracingconsole.ImageManager.TXD_LOADING)
         {
            this.txdRefs[txd] = com.rockstargames.gtav.minigames.horseracingconsole.ImageManager.TXD_LOADING;
   ...
   {
      this.txdRefs[txd] = com.rockstargames.gtav.minigames.horseracingconsole.ImageManager.TXD_LOADED;
