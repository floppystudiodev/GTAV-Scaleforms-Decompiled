      ...
      else
      {
         ...
         switch(AnchorLinkString)
         {
            ...
            case "search_money":
               ...
               if(this.isMP == true)
               {
                  this.searchResults = ["PRIXLUXURYREALESTATE_COM","THEDIAMONDCASINOANDRESORT_COM","FORECLOSURES_MAZE_D_BANK_COM","DYNASTY8EXECUTIVEREALTY_COM","BAWSAQ_COM","DYNASTY8REALESTATE_COM","MAZE_D_BANK_COM"];
                  break;
               }
