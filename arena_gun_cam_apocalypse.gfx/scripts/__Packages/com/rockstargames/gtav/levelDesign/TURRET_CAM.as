class com.rockstargames.gtav.levelDesign.TURRET_CAM extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   var logoState = 0;
   var _isDoubleCompass = true;
   function TURRET_CAM()
   {
      super();
   }
   function set isDoubleCompass(b)
   {
      this._isDoubleCompass = b;
   }
   function get isDoubleCompass()
   {
      return this._isDoubleCompass;
   }
