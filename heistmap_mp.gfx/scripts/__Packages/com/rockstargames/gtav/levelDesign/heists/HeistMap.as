class com.rockstargames.gtav.levelDesign.heists.HeistMap
{
   ...
   function HeistMap(containerMC, mapBitmapData, x, y, xRatio, yRatio, mapCentreX, mapCentreY, isLowerMap)
   {
      ...
      if(isLowerMap)
      {
         _loc3_ = containerMC.getBounds(containerMC._parent._parent);
   ...
   function draw()
   {
      ...
      if(this.pins.length > 0 || this.areas.length > 0 || this.texts.length > 0 || this.highlights.length > 0)
      {
         ...
         {
            this.isDrawing = true;
            _loc10_ = this.assetsMC.getBounds(this.assetsMC);
            _loc14_ = _loc10_.xMin - com.rockstargames.gtav.levelDesign.heists.HeistMap.ZOOM_BUFFER;
            _loc19_ = _loc10_.xMax + com.rockstargames.gtav.levelDesign.heists.HeistMap.ZOOM_BUFFER;
            _loc13_ = _loc10_.yMin - com.rockstargames.gtav.levelDesign.heists.HeistMap.ZOOM_BUFFER;
            _loc18_ = _loc10_.yMax + com.rockstargames.gtav.levelDesign.heists.HeistMap.ZOOM_BUFFER;
            _loc12_ = _loc19_ - _loc14_;
            _loc11_ = _loc18_ - _loc13_;
            _loc21_ = _loc14_ + _loc12_ / 2;
            _loc20_ = _loc13_ + _loc11_ / 2;
            _loc9_ = _loc11_ >= _loc12_ ? com.rockstargames.gtav.levelDesign.heists.HeistMap.MAP_HEIGHT / _loc11_ : com.rockstargames.gtav.levelDesign.heists.HeistMap.MAP_WIDTH / _loc12_;
            ...
            _loc17_ = 100 * _loc9_;
            _loc7_ = 100 / _loc9_;
            _loc16_ = this.mapCentreX - _loc21_ * _loc9_;
            _loc15_ = this.mapCentreY - _loc20_ * _loc9_;
            ...
            while(_loc2_ < _loc3_)
            {
               _loc4_ = this.pins[_loc2_];
               _loc8_ = _loc4_.baseScale / _loc9_;
            ...
            while(_loc2_ < _loc3_)
            {
               _loc6_ = this.postIts[_loc2_];
               _loc6_._xscale = _loc7_;
               _loc6_._yscale = _loc7_;
               _loc6_._visible = true;
               _loc2_ = _loc2_ + 1;
            }
            _loc23_ = _loc16_ - 296.7 * _loc9_;
            _loc22_ = _loc15_ - 475.9 * _loc9_;
   ...
   function removePin(enum)
   {
      ...
      if(_loc2_)
      {
         ...
         _loc3_ = this.pins.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
   ...
   function colourPin(enum, colR, colG, colB, colA, iconEnum)
   {
      ...
      if(_loc2_)
      {
         ...
         {
            _loc5_ = iconEnum != 0 ? "pin_dot" : "pin_outline";
            _loc4_ = "pin_" + enum;
            _loc7_ = _loc2_._x;
            _loc6_ = _loc2_._x;
            _loc3_ = _loc2_._xscale;
            _loc10_ = _loc2_.getDepth();
            _loc2_.removeMovieClip();
   ...
   function removePostIt(enum)
   {
      ...
      {
         _loc2_.removeMovieClip();
         _loc3_ = this.postIts.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
   ...
   function removeArea(enum)
   {
      ...
      {
         _loc2_.removeMovieClip();
         _loc3_ = this.areas.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
   ...
   function removeHighlight(enum)
   {
      ...
      {
         _loc2_.removeMovieClip();
         _loc3_ = this.highlights.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
   ...
   function removeArrow(enum)
   {
      ...
      {
         _loc2_.removeMovieClip();
         _loc3_ = this.arrows.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
   ...
   function removeText(enum)
   {
      ...
      {
         _loc2_.removeMovieClip();
         _loc3_ = this.texts.indexOf(_loc2_);
         if(_loc3_ != -1)
         {
