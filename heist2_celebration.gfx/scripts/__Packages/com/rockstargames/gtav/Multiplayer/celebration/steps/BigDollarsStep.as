class com.rockstargames.gtav.Multiplayer.celebration.steps.BigDollarsStep extends com.rockstargames.gtav.Multiplayer.celebration.steps.Step
{
   var activeLine;
   var bottomLines;
   var counterStep;
   ...
   var topLines;
   var view;
   static var LINE_FADE_OUT_DURATION = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SPEED_MULTIPLIER * 0.25;
   static var PRE_ICON_ANIMATION_PAUSE = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SPEED_MULTIPLIER * 0.5;
   ...
   function init(container, y)
   {
      ...
      var _loc9_ = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_WIDTH - 2 * this.topLines[this.activeLine]._x;
      var _loc8_ = _loc9_ / _loc7_.textWidth;
      if(_loc8_ < 1)
      {
         _loc7_._xscale = _loc7_._yscale = 100 * _loc8_;
         _loc7_._y = -18 + (!(_loc8_ * com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.IS_ASIAN) ? 70 : 10);
      }
      else
      {
         _loc7_._y = -18;
   ...
   function start()
   {
      ...
      com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION,{onComplete:this.startCashCounter,onCompleteScope:this});
   ...
   function showNextStat()
   {
      ...
      com.rockstargames.ui.tweenStar.TweenStarLite.to(_loc2_,com.rockstargames.gtav.Multiplayer.celebration.steps.BigDollarsStep.LINE_FADE_OUT_DURATION,{_alpha:0,ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN});
      var bottomLine = this.bottomLines[this.activeLine];
      var _loc9_ = 0.5 * bottomLine._height;
      com.rockstargames.ui.tweenStar.TweenStarLite.to(bottomLine,com.rockstargames.gtav.Multiplayer.celebration.steps.BigDollarsStep.LINE_FADE_OUT_DURATION,{_y:_loc9_,ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN,_alpha:0,onComplete:this.pauseBeforeDisplayingBottomLine,onCompleteScope:this});
      ...
      var _loc10_ = com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.SCREEN_WIDTH - 2 * _loc2_._x;
      var _loc3_ = _loc10_ / _loc2_.topText.textWidth;
      if(_loc3_ < 1)
      {
         _loc2_.topText._xscale = _loc2_.topText._yscale = 100 * _loc3_;
         _loc2_._y = -18 + (!(_loc3_ * com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.IS_ASIAN) ? 70 : 10);
      }
      else
      {
      ...
      if(_loc8_ == _loc5_)
      {
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(_loc2_,2 * com.rockstargames.gtav.Multiplayer.celebration.steps.BigDollarsStep.LINE_FADE_OUT_DURATION,{onComplete:this.pauseBeforeStartingCashCounter,onCompleteScope:this,onCompleteArgs:[true]});
      }
      else
      {
         _loc6_ = {x:0,y:0};
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.to(_loc2_,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION,{_y:0,ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN,onComplete:this.pauseBeforeStartingCashCounter,onCompleteScope:this,onCompleteArgs:[!_loc4_]});
         if(_loc4_)
         {
            this.sequence.pushDownSteps(170,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION);
            _loc9_ = this.view._y - 120;
            com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION,{_y:_loc9_,ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN});
         }
         switch(this.stats[this.currentStat].soundType)
         {
            case 3:
   ...
   function startCashCounter()
   {
      ...
      var _loc3_ = Math.ceil(com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.FRAME_RATE * com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.POINTS_COUNT_DURATION);
      this.counterStep = 0;
      com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.ONE_FRAME,{onCompleteScope:this,onComplete:this.updateCashCounter,onCompleteArgs:[_loc2_.startDollars,_loc2_.deltaDollars,_loc3_]});
   }
   function pauseBeforeDisplayingBottomLine()
   {
      com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.bottomLines[this.activeLine],com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION - com.rockstargames.gtav.Multiplayer.celebration.steps.BigDollarsStep.LINE_FADE_OUT_DURATION,{onComplete:this.displayBottomLine,onCompleteScope:this});
   }
   function displayBottomLine()
   {
      ...
      _loc2_._y = !com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.IS_WIDESCREEN ? -60 : -20;
      _loc2_._alpha = this.sequence.DEFAULT_TEXT_ALPHA;
      var _loc3_ = 100;
      ...
      var _loc5_ = !com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.IS_WIDESCREEN ? 770 : 960;
      if(_loc6_ > _loc5_)
      {
      ...
      com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(_loc2_.statIcon,com.rockstargames.gtav.Multiplayer.celebration.steps.BigDollarsStep.PRE_ICON_ANIMATION_PAUSE,{onComplete:this.displayIcon,onCompleteScope:this});
   ...
   function updateCashCounter(startValue, delta, duration)
   {
      ...
      {
         com.rockstargames.ui.tweenStar.TweenStarLite.removeTweenOf(this.view);
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.POST_POINTS_COUNT_PAUSE,{onComplete:this.showNextStat,onCompleteScope:this});
         if(delta != 0)
         {
            switch(this.stats[this.currentStat].soundType)
            {
      ...
      {
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.ONE_FRAME,{onCompleteScope:this,onComplete:this.updateCashCounter,onCompleteArgs:[startValue,delta,duration]});
      }
   }
