class com.rockstargames.gtav.Multiplayer.celebration.steps.CashStep extends com.rockstargames.gtav.Multiplayer.celebration.steps.Step
{
   ...
   function startCounter()
   {
      ...
      this.counterStep = 0;
      com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.ONE_FRAME,{onCompleteScope:this,onComplete:this.updateCounter,onCompleteArgs:[this.startValue,this.finalValue - this.startValue,_loc2_]});
   }
   function updateCounter(startValue, delta, duration)
   {
      ...
      {
         com.rockstargames.ui.tweenStar.TweenStarLite.removeTweenOf(this.view);
         com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.POST_POINTS_COUNT_PAUSE,{onCompleteScope:this,onComplete:this.stepComplete});
      }
      else
      {
   ...
   function stepComplete()
   {
      ...
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.sequence.previousStep.view,com.rockstargames.gtav.Multiplayer.celebration.CelebrationSequence.DEFAULT_PUSHDOWN_DURATION,{_y:_loc2_,ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_IN});
