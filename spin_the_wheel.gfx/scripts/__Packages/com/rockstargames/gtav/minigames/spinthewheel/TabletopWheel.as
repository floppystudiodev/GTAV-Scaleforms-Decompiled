class com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel extends com.rockstargames.gtav.minigames.spinthewheel.Wheel
{
   ...
   var segmentFormatMethods = [com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.prototype.formatBlankSegment,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.prototype.formatPowerUpSegment,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.prototype.formatCashSegment,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.prototype.formatRPSegment,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.prototype.formatAPSegment,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.prototype.formatFreeSpinSegment,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.prototype.formatRandomSegment];
   var segmentSuffixes = ["","",""," RP"," AP","",""];
   function TabletopWheel(container, numSegments, x, y, isSpectatorWheel, displayConfig)
   {
      super(container,numSegments,x,y,"tabletopWheel");
      this.isSpectatorWheel = isSpectatorWheel;
      if(isSpectatorWheel)
      {
         this.view.altIcons._visible = true;
         this.view.altTitle.verticalAlign = "center";
         this.view.altTitle.textAutoSize = "shrink";
         com.rockstargames.gtav.minigames.spinthewheel.SPIN_THE_WHEEL.setLocalisedText(this.view.altTitle,"SPINWHEEL_SPECTATE");
      }
      else
      {
         this.view.altIcons._visible = false;
   ...
   function addSegment(index, type, value)
   {
      ...
      var _loc2_ = this.view.attachMovie("tabletopSegment","segment" + _loc3_,_loc3_);
      _loc2_._xscale = 90;
      _loc2_._yscale = 90;
      _loc2_._rotation = 360 * index / this.segments.length + 180;
      ...
      _loc2_._alpha = 0;
      com.rockstargames.ui.tweenStar.TweenStarLite.to(_loc2_,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.INITIAL_FADE_IN_DURATION,{delay:index * com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.INITIAL_FADE_IN_DELAY,_alpha:100});
      this.view.altIcons._visible = false;
      return _loc2_;
   }
   ...
   function initWinAnimation()
   {
      ...
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.centreIcon.overlay,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.WIN_ANIM_DURATION,{_xscale:105,_yscale:105,ease:com.rockstargames.ui.tweenStar.Ease.QUARTIC_IN,onCompleteScope:this,onComplete:this.flashWinAnimation});
      this.view.centreIcon._xscale = 60;
      this.view.centreIcon._yscale = 60;
      this.view.centreIcon._alpha = 100;
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.centreIcon,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.WIN_ANIM_DURATION,{_xscale:100,_yscale:100,ease:com.rockstargames.ui.tweenStar.Ease.CIRCULAR_INOUT,onCompleteScope:this,onComplete:this.initReset});
   ...
   function flashWinAnimation()
   {
      ...
      this.view.centreIcon.overlay._xscale = 100;
      this.view.centreIcon.overlay._yscale = 100;
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.centreIcon.overlay,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.WIN_FLASH_DURATION,{_alpha:0});
   }
   function initReset()
   {
      com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.centreIcon,com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.WIN_FLASH_DURATION,{delay:this.winPauseDuration - com.rockstargames.gtav.minigames.spinthewheel.TabletopWheel.WIN_FLASH_DURATION,_alpha:0,onCompleteScope:this,onComplete:this.reset});
   }
   function reset()
   {
