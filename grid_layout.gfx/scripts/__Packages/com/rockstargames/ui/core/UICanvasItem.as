   ...
   function setPosition(gridList)
   {
      ...
      switch(this.anchor)
      {
         ...
         default:
            ...
            break;
         case 1:
            _loc4_ += _loc2_.x + _loc2_.width * 0.5 - this.scaledBounds.width * 0.5;
            _loc3_ += _loc2_.y;
            break;
         case 2:
            _loc4_ += _loc2_.x + _loc2_.width - this.scaledBounds.width;
            _loc3_ += _loc2_.y;
            break;
         case 3:
            _loc4_ += _loc2_.x;
            _loc3_ += _loc2_.y + _loc2_.height * 0.5 - this.scaledBounds.height * 0.5;
            break;
         case 4:
            _loc4_ += _loc2_.x + _loc2_.width * 0.5 - this.scaledBounds.width * 0.5;
            _loc3_ += _loc2_.y + _loc2_.height * 0.5 - this.scaledBounds.height * 0.5;
         ...
         case 6:
            _loc4_ += _loc2_.x;
            _loc3_ += _loc2_.y + _loc2_.height - this.scaledBounds.height;
            break;
         case 7:
            _loc4_ += _loc2_.x + _loc2_.width * 0.5 - this.scaledBounds.width * 0.5;
            _loc3_ += _loc2_.y + _loc2_.height - this.scaledBounds.height;
