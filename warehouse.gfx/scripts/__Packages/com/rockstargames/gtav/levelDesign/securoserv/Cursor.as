class com.rockstargames.gtav.levelDesign.securoserv.Cursor
{
   ...
   function Cursor(view, debugView, displayConfig)
   {
      ...
      {
         this.xMin += com.rockstargames.gtav.levelDesign.securoserv.Cursor.LEFT_MARGIN;
      }
      if(displayConfig.safeRight == 1)
      {
         this.xMax -= com.rockstargames.gtav.levelDesign.securoserv.Cursor.RIGHT_MARGIN;
      }
      if(displayConfig.safeTop == 0)
      {
         this.yMin += com.rockstargames.gtav.levelDesign.securoserv.Cursor.TOP_MARGIN;
      }
      if(displayConfig.safeBottom == 1)
      {
         this.yMax -= com.rockstargames.gtav.levelDesign.securoserv.Cursor.BOTTOM_MARGIN;
      }
   ...
   function moveTo(x, y, instant, absolute)
   {
      if(!absolute)
      {
         x *= com.rockstargames.gtav.levelDesign.securoserv.Cursor.STAGE_WIDTH;
         y *= com.rockstargames.gtav.levelDesign.securoserv.Cursor.STAGE_HEIGHT;
      }
