class com.rockstargames.gtav.web.prixluxuryrealestate.ImageManager
{
   var gfxName;
   var imageQueue;
   var txdRefs;
   ...
   {
      if(com.rockstargames.gtav.web.prixluxuryrealestate.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == com.rockstargames.gtav.web.prixluxuryrealestate.ImageManager.TXD_LOADED)
      {
         this.displayImage(txd,id,imageMovieClip,fadeInWhenLoaded);
      }
      else
      {
         if(this.txdRefs[txd] != com.rockstargames.gtav.web.prixluxuryrealestate.ImageManager.TXD_LOADING)
         {
            this.txdRefs[txd] = com.rockstargames.gtav.web.prixluxuryrealestate.ImageManager.TXD_LOADING;
   ...
   {
      this.txdRefs[txd] = com.rockstargames.gtav.web.prixluxuryrealestate.ImageManager.TXD_LOADED;
   ...
   function displayImage(txd, id, imageMovieClip, fadeIn)
   {
      ...
      if(fadeIn)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.to(imageMovieClip,com.rockstargames.gtav.web.prixluxuryrealestate.ImageManager.FADE_IN_DURATION,{_alpha:100});
      }
   }
   function dispose()
   {
