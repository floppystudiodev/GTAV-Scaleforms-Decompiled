class com.rockstargames.gtav.levelDesign.VAULT_LASER extends com.rockstargames.ui.core.BaseScreenLayout
{
   ...
   function updateDiscs(y, allowHoleFilling)
   {
      ...
      while(_loc2_ < this.discs.length)
      {
         var _loc3_ = Math.round((this.discs[_loc2_]._totalframes - 1) * (com.rockstargames.gtav.levelDesign.VAULT_LASER.DISC_ENTER_POSITIONS[_loc2_] - y) / (com.rockstargames.gtav.levelDesign.VAULT_LASER.DISC_ENTER_POSITIONS[_loc2_] - com.rockstargames.gtav.levelDesign.VAULT_LASER.DISC_EXIT_POSITIONS[_loc2_])) + 1;
