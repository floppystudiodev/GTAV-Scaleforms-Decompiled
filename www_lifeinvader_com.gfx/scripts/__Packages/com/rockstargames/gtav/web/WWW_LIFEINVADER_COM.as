class com.rockstargames.gtav.web.WWW_LIFEINVADER_COM extends com.rockstargames.ui.core.BaseWebsite
{
   ...
   function POPULATE_TEXT(pageName, searchArgs, newPage)
   {
      ...
      if(newPage == true)
      {
         var _loc2_ = "LFI_STRAPLINE" + this.randRange(1,10);
      ...
      switch(pageName)
      {
         ...
         case "ERROR":
            ...
            else if(this.dataProviderUI[1] != undefined && this.dataProviderUI[1] != "")
            {
   ...
   function updateSponsoredAds()
   {
      if(this.mcScope.sponsoredAds != undefined)
      {
         ...
         while(_loc2_ < 4)
         {
            var _loc3_ = _loc5_.splice(this.randRange(0,_loc5_.length - 1),1);
            _loc6_ = 48 + _loc2_ * 77;
            var _loc4_ = this.adContainer.attachMovie(_loc3_[0],_loc3_[0],this.adContainer.getNextHighestDepth(),{_x:2,_y:_loc6_});
   ...
   function makeLists()
   {
      ...
      while(_loc9_ < this.dataProviderUI.length)
      {
         ...
         {
            var _loc3_ = this.postContainer.attachMovie("MC_sidebar_box","MC_sidebar_box" + this.sideBarItem,this.postContainer.getNextHighestDepth(),{_x:this.sideBarX,_y:this.sideBarY});
         ...
         {
            var _loc12_ = "MC_message_box" + this.listItem;
            var _loc6_ = this.dataProviderUI[_loc2_][3];
            var _loc7_ = _loc6_.indexOf("www.");
            if(_loc7_ != -1)
            {
               var _loc11_ = _loc6_.substr(_loc7_ + 1).indexOf(" ");
               if(_loc11_ == -1)
               {
                  _loc11_ = _loc6_.length;
               }
               var _loc8_ = _loc6_.substr(_loc7_,_loc11_ + 1);
               _loc12_ = this.browser.PARSE_TEXT_TO_FILENAME(_loc8_);
               var _loc14_ = _loc6_.split(_loc8_);
               _loc6_ = _loc14_[0] + "<font color=\'#2f5c73\'>" + _loc8_ + "</font>" + _loc14_[1];
               this.dataProviderUI[_loc2_][5] = true;
            }
            var _loc4_ = this.postContainer.attachMovie("MC_message_box",_loc12_,this.postContainer.getNextHighestDepth(),{_x:this.listX,_y:this.listY});
            if(this.dataProviderUI[_loc2_][1] != undefined && this.dataProviderUI[_loc2_][1] != "")
            {
         ...
         {
            var _loc5_ = this.postContainer.attachMovie("MC_friends_box","MC_friends_box" + this.listItem,this.postContainer.getNextHighestDepth(),{_x:this.listX,_y:this.listY});
            if(this.dataProviderUI[_loc2_][1] != undefined && this.dataProviderUI[_loc2_][1] != "")
            {
            ...
            var _loc13_ = _loc5_.messageTF._y + _loc5_.messageTF._height + 4;
            if(_loc13_ > 48)
            {
         ...
         {
            var _loc10_ = this.postContainer.attachMovie("MC_text_box","MC_text_box" + this.listItem,this.postContainer.getNextHighestDepth(),{_x:this.listX,_y:this.listY});
            if(this.dataProviderUI[_loc2_][1] != undefined && this.dataProviderUI[_loc2_][1] != "")
            {
