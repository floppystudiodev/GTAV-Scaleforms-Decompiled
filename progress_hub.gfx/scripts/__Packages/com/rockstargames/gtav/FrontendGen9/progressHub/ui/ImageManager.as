class com.rockstargames.gtav.FrontendGen9.progressHub.ui.ImageManager
{
   var gfxName;
   var imageQueue;
   var txdRefs;
   ...
   function addImage(txd, texture, imageMovieClip)
   {
      ...
      if(com.rockstargames.gtav.FrontendGen9.progressHub.ui.ImageManager.USE_REFERENCE_COUNTING && this.txdRefs[txd] == com.rockstargames.gtav.FrontendGen9.progressHub.ui.ImageManager.TXD_LOADED)
      {
         this.displayImage(txd,texture,imageMovieClip);
      }
      else
      {
         if(this.txdRefs[txd] != com.rockstargames.gtav.FrontendGen9.progressHub.ui.ImageManager.TXD_LOADING)
         {
            this.txdRefs[txd] = com.rockstargames.gtav.FrontendGen9.progressHub.ui.ImageManager.TXD_LOADING;
   ...
   {
      this.txdRefs[txd] = com.rockstargames.gtav.FrontendGen9.progressHub.ui.ImageManager.TXD_LOADED;
   ...
   function displayImage(txd, texture, imageMovieClip)
   {
      ...
      var _loc3_ = {onLoadInit:function(imageMovieClip)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.to(imageMovieClip,0.1,{_alpha:100});
