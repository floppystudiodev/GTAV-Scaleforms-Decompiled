class com.rockstargames.gtav.levelDesign.hackerTruckDesktop.Slideshow
{
   ...
   function crossfade()
   {
      ...
      com.rockstargames.ui.tweenStar.TweenStarLite.to(_loc2_,com.rockstargames.gtav.levelDesign.hackerTruckDesktop.Slideshow.CROSSFADE_TIME,this.crossfadeArgs);
   }
   function pause()
   {
      com.rockstargames.ui.tweenStar.TweenStarLite.delayCall(this.slides[this.index],com.rockstargames.gtav.levelDesign.hackerTruckDesktop.Slideshow.PAUSE_TIME,this.pauseArgs);
   }
   function dispose()
   {
      this.stopSlideshow();
