class com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Overlay
{
   var view;
   var actionButtons;
   ...
   function init()
   {
      ...
      this.actionButtons = [];
      this.actionButtons.push(new com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Button(com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.ButtonIDs.OVERLAY_CANCEL,this.view.cancelButton));
      this.actionButtons.push(new com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Button(com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.ButtonIDs.OVERLAY_ACCEPT,this.view.acceptButton));
   ...
   function show(title, message, acceptButtonLabel, cancelButtonLabel, showImmediately)
   {
      ...
      this.view.title._y = 0.5 * (com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Overlay.HEIGHT - _loc6_);
      ...
      {
         this.view.acceptButton._x = Math.floor(com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Overlay.CENTRE_X - 0.5 * this.view.acceptButton._width);
         this.view.cancelButton._x = com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Overlay.CENTRE_X << 1;
      }
      else if(acceptButtonLabel.length == 0)
      {
         this.view.cancelButton._x = Math.floor(com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Overlay.CENTRE_X - 0.5 * this.view.cancelButton._width);
         this.view.acceptButton._x = com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Overlay.CENTRE_X << 1;
      }
      else
      {
      ...
      if(!showImmediately)
      {
         ...
         com.rockstargames.ui.tweenStar.TweenStarLite.to(this.view.screenBG,com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Overlay.ELEMENT_FADE_IN_DURATION,{_alpha:90,ease:com.rockstargames.ui.tweenStar.Ease.QUARTIC_OUT});
      }
