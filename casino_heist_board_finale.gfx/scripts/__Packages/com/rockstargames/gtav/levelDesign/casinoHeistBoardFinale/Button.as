class com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Button
{
   var id;
   var view;
   var depth;
   ...
   function Button(id, view, label, isStringLiteral)
   {
      ...
      view.selected.transform.colorTransform = com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Button.RED;
   ...
   function setLabel(label, isStringLiteral)
   {
      if(this.view.label && label)
      {
         ...
         {
            com.rockstargames.gtav.levelDesign.CASINO_HEIST_BOARD_FINALE.setLocalisedText(this.view.label,label);
         }
      }
   }
   ...
   function set selected(isSelected)
   {
      ...
      {
         this.view.gotoAndStop(!isSelected ? "off" : "on");
      }
   }
   function set selectedIsGreyedOut(isGreyedOut)
   {
      this.view.selected.transform.colorTransform = !isGreyedOut ? com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Button.RED : com.rockstargames.gtav.levelDesign.casinoHeistBoardFinale.Button.GREY;
   }
