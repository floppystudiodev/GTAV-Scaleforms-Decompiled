class com.rockstargames.gtav.web.foreclosures.HelitoursSummaryPage extends com.rockstargames.gtav.web.foreclosures.Page
{
   ...
   function HelitoursSummaryPage(website, viewContainer, pageName, isFirstPage, progressPanel, header)
   {
      super(website,viewContainer,"helitoursSummaryPage",pageName,isFirstPage,progressPanel,header);
      this.init();
   }
   function init()
   {
      ...
      this.prevPageName = com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.PAGES.HELITOURS_TINT_PAGE.name;
      this.progressPanel.show();
      this.progressPanel.initHelitoursProgress(2);
      ...
      this.slideshow.show([com.rockstargames.gtav.web.foreclosures.HelitoursSummaryPage.TXD],["tint_" + (this.website.helitoursTint + 1)]);
   }
   function initThumbnails()
   {
      this.website.imageManager.addImage(com.rockstargames.gtav.web.foreclosures.HelitoursSummaryPage.TXD,"tint_" + (this.website.helitoursTint + 1),this.view.tint);
   }
   function initPurchaseButton()
   {
      ...
      var _loc2_ = this.website.getSelectedHelitours();
      if(_loc2_.isOwned && this.website.helitoursTint == this.website.purchasedHelitoursTint)
      {
   ...
   {
      var _loc3_ = this.website.getSelectedHelitours();
      var _loc2_ = !_loc3_.isOwned ? _loc3_.getBaseBestCost() : 0;
      _loc2_ += _loc3_.getTintBestCost(this.website.helitoursTint,this.website.purchasedHelitoursTint);
   ...
   function handleClick(type, id)
   {
      ...
      {
         case "purchaseButton":
            this.website.dispatchPlayerHelitoursSelections();
