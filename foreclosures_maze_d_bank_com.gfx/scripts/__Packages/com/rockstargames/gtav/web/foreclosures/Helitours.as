class com.rockstargames.gtav.web.foreclosures.Helitours
{
   var _address;
   var _description;
   var _id;
   ...
   static var TINT_COST_RANGE = [9,17];
   static var BASE_SALE_COST = 18;
   static var TINT_SALE_COST_RANGE = [19,27];
   static var MAP_COORD_SCALE = 0.3415;
   static var MAP_ORIGIN_X = 1415.5;
   static var MAP_ORIGIN_Y = 2774;
   function Helitours(data, _isOwned)
   {
      this._id = data[com.rockstargames.gtav.web.foreclosures.Helitours.ID];
      this._name = data[com.rockstargames.gtav.web.foreclosures.Helitours.NAME];
      this._type = data[com.rockstargames.gtav.web.foreclosures.Helitours.TYPE];
      this._address = data[com.rockstargames.gtav.web.foreclosures.Helitours.ADDRESS];
      this._description = data[com.rockstargames.gtav.web.foreclosures.Helitours.DESCRIPTION];
      this._x = data[com.rockstargames.gtav.web.foreclosures.Helitours.X] * com.rockstargames.gtav.web.foreclosures.Helitours.MAP_COORD_SCALE + com.rockstargames.gtav.web.foreclosures.Helitours.MAP_ORIGIN_X;
      this._y = data[com.rockstargames.gtav.web.foreclosures.Helitours.Y] * (- com.rockstargames.gtav.web.foreclosures.Helitours.MAP_COORD_SCALE) + com.rockstargames.gtav.web.foreclosures.Helitours.MAP_ORIGIN_Y;
      this._txd = data[com.rockstargames.gtav.web.foreclosures.Helitours.TXD];
      this._isOwned = _isOwned;
      this._isInStarterPack = false;
      this.baseCost = data[com.rockstargames.gtav.web.foreclosures.Helitours.BASE_COST];
      this.baseSaleCost = data[com.rockstargames.gtav.web.foreclosures.Helitours.BASE_SALE_COST];
      this.tintCosts = this.setupCosts(data,com.rockstargames.gtav.web.foreclosures.Helitours.TINT_COST_RANGE);
      this.tintSaleCosts = this.setupCosts(data,com.rockstargames.gtav.web.foreclosures.Helitours.TINT_SALE_COST_RANGE);
   }
