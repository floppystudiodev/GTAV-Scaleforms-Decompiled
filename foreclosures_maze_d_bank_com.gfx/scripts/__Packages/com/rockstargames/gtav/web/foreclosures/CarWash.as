class com.rockstargames.gtav.web.foreclosures.CarWash
{
   var _address;
   var _description;
   var _id;
   ...
   function CarWash(data, _isOwned)
   {
      this._id = data[com.rockstargames.gtav.web.foreclosures.CarWash.ID];
      this._name = data[com.rockstargames.gtav.web.foreclosures.CarWash.NAME];
      this._type = data[com.rockstargames.gtav.web.foreclosures.CarWash.TYPE];
      this._address = data[com.rockstargames.gtav.web.foreclosures.CarWash.ADDRESS];
      this._description = data[com.rockstargames.gtav.web.foreclosures.CarWash.DESCRIPTION];
      this._x = data[com.rockstargames.gtav.web.foreclosures.CarWash.X] * com.rockstargames.gtav.web.foreclosures.CarWash.MAP_COORD_SCALE + com.rockstargames.gtav.web.foreclosures.CarWash.MAP_ORIGIN_X;
      this._y = data[com.rockstargames.gtav.web.foreclosures.CarWash.Y] * (- com.rockstargames.gtav.web.foreclosures.CarWash.MAP_COORD_SCALE) + com.rockstargames.gtav.web.foreclosures.CarWash.MAP_ORIGIN_Y;
      this._txd = data[com.rockstargames.gtav.web.foreclosures.CarWash.TXD];
      this._isOwned = _isOwned;
      this._isInStarterPack = false;
      this.baseCost = data[com.rockstargames.gtav.web.foreclosures.CarWash.BASE_COST];
      this.baseSaleCost = data[com.rockstargames.gtav.web.foreclosures.CarWash.BASE_SALE_COST];
      this.tintCosts = this.setupCosts(data,com.rockstargames.gtav.web.foreclosures.CarWash.TINT_COST_RANGE);
      this.tintSaleCosts = this.setupCosts(data,com.rockstargames.gtav.web.foreclosures.CarWash.TINT_SALE_COST_RANGE);
   }
