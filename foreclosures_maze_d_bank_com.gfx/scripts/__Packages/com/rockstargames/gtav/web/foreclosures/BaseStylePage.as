class com.rockstargames.gtav.web.foreclosures.BaseStylePage extends com.rockstargames.gtav.web.foreclosures.Page
{
   var website;
   var prevPageName;
   var nextPageName;
   ...
   function BaseStylePage(website, viewContainer, pageName, isFirstPage, progressPanel, header)
   {
      super(website,viewContainer,"baseStylePage",pageName,isFirstPage,progressPanel,header);
      this.init();
   }
   function init()
   {
      ...
      this.nextPageName = com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.PAGES.BASE_GRAPHICS_PAGE.name;
      this.summaryPageName = com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.PAGES.BASE_SUMMARY_PAGE.name;
      this.progressPanel.show();
      this.progressPanel.initBaseProgress(1);
      this.initSlideshow();
   ...
   function handleClick(type, id)
   {
      switch(type)
      {
         case "optionButton":
            ...
            var _loc3_ = _loc2_ != this.website.baseStyle;
            this.website.baseStyle = _loc2_;
   ...
   function updateSelectedItem(selectionHasChanged)
   {
      ...
      {
         var _loc3_ = this.view.optionButtons["optionButton_" + _loc2_];
         _loc3_.selected._visible = _loc2_ == this.website.baseStyle;
         _loc2_ = _loc2_ + 1;
      }
      this.slideshow.show([com.rockstargames.gtav.web.foreclosures.BaseStylePage.TXD],["style" + (this.website.baseStyle + 1)]);
      com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setSpacedTextField(this.view.description,"FCBASE_STY_DESC_" + this.website.baseStyle,false);
