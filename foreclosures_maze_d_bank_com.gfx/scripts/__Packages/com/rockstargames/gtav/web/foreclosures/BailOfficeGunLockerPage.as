class com.rockstargames.gtav.web.foreclosures.BailOfficeGunLockerPage extends com.rockstargames.gtav.web.foreclosures.Page
{
   var website;
   var prevPageName;
   var nextPageName;
   ...
   function BailOfficeGunLockerPage(website, viewContainer, pageName, isFirstPage, progressPanel, header)
   {
      super(website,viewContainer,"bailOfficeGunLockerPage",pageName,isFirstPage,progressPanel,header);
      this.init();
   }
   function init()
   {
      ...
      this.progressPanel.initBailOfficeProgress(4);
      com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setSpacedTextField(this.view.description,"FCBAIL_GUNLOCKER_DESC",false);
      this.initSlideshow();
      this.initOptionButtons();
      this.updateSelectedItem(false);
      this.website.browser.SET_PAGE_BUTTONS(this.website.dataTextScope);
      this.slideshow.show([com.rockstargames.gtav.web.foreclosures.BailOfficeGunLockerPage.TXD],["gun_locker"]);
   }
   ...
   function initOptionButtons()
   {
      ...
      _loc2_ = this.view.gunLockerButton;
      ...
      com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setSpacedTextField(_loc2_.btnTxt,"FCBAIL_GUNLOCKER",false);
      if(!this.website.getSelectedBailOffice().isOwned || this.website.purchasedBailOfficeGunLocker == 0)
      {
   ...
   function handleClick(type, id)
   {
      switch(type)
      {
         case "gunLockerButton":
            this.website.bailOfficeGunLocker = this.website.bailOfficeGunLocker != 0 ? 0 : 1;
   ...
   {
      this.view.gunLockerButton.tick._visible = this.website.bailOfficeGunLocker == 1;
