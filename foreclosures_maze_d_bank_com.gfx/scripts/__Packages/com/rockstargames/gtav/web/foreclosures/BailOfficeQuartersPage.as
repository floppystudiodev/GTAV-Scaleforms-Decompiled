class com.rockstargames.gtav.web.foreclosures.BailOfficeQuartersPage extends com.rockstargames.gtav.web.foreclosures.Page
{
   var website;
   var prevPageName;
   var nextPageName;
   ...
   function BailOfficeQuartersPage(website, viewContainer, pageName, isFirstPage, progressPanel, header)
   {
      super(website,viewContainer,"bailOfficeQuartersPage",pageName,isFirstPage,progressPanel,header);
      this.init();
   }
   function init()
   {
      ...
      this.progressPanel.initBailOfficeProgress(3);
      com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setSpacedTextField(this.view.description,"FCBAIL_QUARTERS_DESC",false);
      this.initSlideshow();
      this.initOptionButtons();
      this.updateSelectedItem(false);
      this.website.browser.SET_PAGE_BUTTONS(this.website.dataTextScope);
      this.slideshow.show([com.rockstargames.gtav.web.foreclosures.BailOfficeQuartersPage.TXD],["quarters"]);
   }
   ...
   function initOptionButtons()
   {
      ...
      com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setSpacedTextField(_loc2_.btnTxt,"FCBAIL_QUARTERS",false);
      if(!this.website.getSelectedBailOffice().isOwned || this.website.purchasedBailOfficeQuarters == 0)
      {
   ...
   function handleClick(type, id)
   {
      ...
      {
         case "quartersButton":
            this.website.bailOfficeQuarters = this.website.bailOfficeQuarters != 0 ? 0 : 1;
   ...
   {
      this.view.quartersButton.tick._visible = this.website.bailOfficeQuarters == 1;
