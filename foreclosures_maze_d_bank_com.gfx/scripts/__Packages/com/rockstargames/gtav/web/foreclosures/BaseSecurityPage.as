class com.rockstargames.gtav.web.foreclosures.BaseSecurityPage extends com.rockstargames.gtav.web.foreclosures.Page
{
   var nextPageName;
   var prevPageName;
   var progressPanel;
   ...
   function BaseSecurityPage(website, viewContainer, pageName, isFirstPage, progressPanel, header)
   {
      super(website,viewContainer,"baseSecurityPage",pageName,isFirstPage,progressPanel,header);
      this.init();
   }
   function init()
   {
      ...
      {
         this.prevPageName = com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.PAGES.BASE_WEAPON_PAGE.name;
      }
      else
      {
      ...
      com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setSpacedTextField(this.view.description,"FCBASE_SEC_DESC",false);
      this.progressPanel.show();
      this.progressPanel.initBaseProgress(4);
      this.initSlideshow();
   ...
   function initSlideshow()
   {
      ...
      this.slideshow.show([com.rockstargames.gtav.web.foreclosures.BaseSecurityPage.TXD],["security"]);
   }
   function initOptionButton(buttonView)
   {
      ...
      com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM.setSpacedTextField(buttonView.btnTxt,"FCBASE_SEC",false);
      if(!this.website.getSelectedBase().isOwned || this.website.purchasedBaseSecurity == 0)
      {
   ...
   function handleClick(type, id)
   {
      ...
      {
         case "optionButton":
            this.website.baseSecurity = this.website.baseSecurity != 0 ? 0 : 1;
            this.updateSelectedItem();
            break;
         case "purchaseButton":
   ...
   {
      this.view.optionButton.tick._visible = this.website.baseSecurity != 0;
