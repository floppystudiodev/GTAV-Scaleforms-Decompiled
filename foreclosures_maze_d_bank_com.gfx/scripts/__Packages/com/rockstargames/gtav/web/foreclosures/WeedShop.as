class com.rockstargames.gtav.web.foreclosures.WeedShop
{
   var _address;
   var _description;
   var _id;
   ...
   function WeedShop(data, _isOwned)
   {
      this._id = data[com.rockstargames.gtav.web.foreclosures.WeedShop.ID];
      this._name = data[com.rockstargames.gtav.web.foreclosures.WeedShop.NAME];
      this._type = data[com.rockstargames.gtav.web.foreclosures.WeedShop.TYPE];
      this._address = data[com.rockstargames.gtav.web.foreclosures.WeedShop.ADDRESS];
      this._description = data[com.rockstargames.gtav.web.foreclosures.WeedShop.DESCRIPTION];
      this._x = data[com.rockstargames.gtav.web.foreclosures.WeedShop.X] * com.rockstargames.gtav.web.foreclosures.WeedShop.MAP_COORD_SCALE + com.rockstargames.gtav.web.foreclosures.WeedShop.MAP_ORIGIN_X;
      this._y = data[com.rockstargames.gtav.web.foreclosures.WeedShop.Y] * (- com.rockstargames.gtav.web.foreclosures.WeedShop.MAP_COORD_SCALE) + com.rockstargames.gtav.web.foreclosures.WeedShop.MAP_ORIGIN_Y;
      this._txd = data[com.rockstargames.gtav.web.foreclosures.WeedShop.TXD];
      this._isOwned = _isOwned;
      this._isInStarterPack = false;
      this.baseCost = data[com.rockstargames.gtav.web.foreclosures.WeedShop.BASE_COST];
      this.baseSaleCost = data[com.rockstargames.gtav.web.foreclosures.WeedShop.BASE_SALE_COST];
      this.tintCosts = this.setupCosts(data,com.rockstargames.gtav.web.foreclosures.WeedShop.TINT_COST_RANGE);
      this.tintSaleCosts = this.setupCosts(data,com.rockstargames.gtav.web.foreclosures.WeedShop.TINT_SALE_COST_RANGE);
   }
