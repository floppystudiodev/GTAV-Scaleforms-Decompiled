class com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM extends com.rockstargames.gtav.web.FORECLOSURES_MAZE_D_BANK_COM_WRAPPER
{
   ...
   var salvageYards;
   var setSelectedArcade;
   var setSelectedAutoShop;
   var setSelectedBailOffice;
   var setSelectedBase;
   var setSelectedBunker;
   var setSelectedCarWash;
   var setSelectedClubhouse;
   var setSelectedGarmentFactory;
   var setSelectedHangar;
   var setSelectedHelitours;
   var setSelectedMcKenzieHangar;
   var setSelectedNightclub;
   var setSelectedSalvageYard;
   var setSelectedWeedShop;
   var videoDisabled;
   var weedShop;
