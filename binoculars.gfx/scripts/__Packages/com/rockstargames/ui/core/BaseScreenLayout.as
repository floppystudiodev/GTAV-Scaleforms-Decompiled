class com.rockstargames.ui.core.BaseScreenLayout extends com.rockstargames.gtav.levelDesign.BaseScriptUI
{
   ...
   function getDisplayConfig(shouldSet)
   {
      ...
      if(shouldSet)
      {
         this.SET_DISPLAY_CONFIG(_loc2_.screenWidth,_loc2_.screenHeight,_loc2_.safeTop,_loc2_.safeBottom,_loc2_.safeLeft,_loc2_.safeRight,_loc2_.isWideScreen,_loc2_.isHiDef);
      }
      return _loc2_;
   }
   ...
   function positionToScreenLayout(mc, position, onPixel)
   {
      ...
      switch(position)
      {
         ...
         case "xRB":
            ...
            break;
         case "xCC":
            _loc3_ = this.safeLeft + (this.safeRight - this.safeLeft) / 2;
